...
#ifndef STRESSTEST_StressTestComponent57_H_
#define STRESSTEST_StressTestComponent57_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent57,StressTestComponent57, public ConsoleApplication)
public:
	StressTestComponent57();
	...
	static StressTestComponent57 mInstance;
...
#endif /* STRESSTEST_StressTestComponent57_H_ */
