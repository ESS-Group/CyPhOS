...
#include "StressTestComponent_generic_24.h"

#define TAG "StressTestComponent23"
...
BEGIN_OSC_IMPLEMENTATION(StressTestComponent23,StressTestComponent23)

StressTestComponent23 StressTestComponent23::mInstance;

SECTION_CRITICAL_DATA OSC* StressTestComponent23::trigger_deps_doStress[] = {nullptr};

SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent23::trigger_doStress = {(OSC*)&StressTestComponent23::mInstance,(void (OSC::*)(dword_t))&StressTestComponent23::func_doStress,
				(OSC**)&StressTestComponent23::trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 23 + 1,0x0};

SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent23::trigger_subscribe = {(OSC*)&StressTestComponent23::mInstance,(void (OSC::*)(dword_t))&StressTestComponent23::func_subscribe,
				(OSC**)&StressTestComponent23::trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 23 + 2};

SECTION_CRITICAL_DATA OSC* StressTestComponent23::trigger_deps_printOut[] = {CONSOLE_BUFFER_DEP,nullptr};
SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent23::trigger_printOut = {(OSC*)&StressTestComponent23::mInstance,(void (OSC::*)(dword_t))&StressTestComponent23::func_printOut,
				(OSC**)&StressTestComponent23::trigger_deps_printOut, EventHandling::Trigger::cMIN_Priority + 21000 + 23 + 3};

SECTION_CRITICAL_DATA EventHandling::Event StressTestComponent23::event_Continue;

SECTION_CRITICAL_DATA DEFINE_TRIGGER(StressTestComponent23,selfCall,StressTestComponent23::mInstance,trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 2003);


StressTestComponent23::StressTestComponent23() : mIterations(0), mMin(0xFFFFFFFF), mMax(0) {
//	EventHandling::EventHandler::pInstance.subscribeEvent(&OSC_PREFIX(StressTestComponent24)::StressTestComponent24::event_Continue, &trigger_doStress);
}

void StressTestComponent23::func_doStress(dword_t arg) {
...
void StressTestComponent23::func_printOut(dword_t arg) {
...
void StressTestComponent23::func_subscribe(dword_t arg) {
//	EventHandling::EventHandler::pInstance.subscribeEvent(&OSC_PREFIX(StressTestComponent24)::StressTestComponent24::event_Continue, &trigger_doStress);
	EventHandling::EventHandler::pInstance.eventTriggered(&event_Continue,0);
}

DEFINE_TRIGGER_FUNC(StressTestComponent23,selfCall) {
	mIterations++;
