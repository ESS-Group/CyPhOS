...
#ifndef STRESSTEST_StressTestComponent85_H_
#define STRESSTEST_StressTestComponent85_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent85,StressTestComponent85, public ConsoleApplication)
public:
	StressTestComponent85();
	...
	static StressTestComponent85 mInstance;
...
#endif /* STRESSTEST_StressTestComponent85_H_ */
