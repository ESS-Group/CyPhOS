...
#ifndef STRESSTEST_StressTestComponent64_H_
#define STRESSTEST_StressTestComponent64_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent64,StressTestComponent64, public ConsoleApplication)
public:
	StressTestComponent64();
	...
	static StressTestComponent64 mInstance;
...
#endif /* STRESSTEST_StressTestComponent64_H_ */
