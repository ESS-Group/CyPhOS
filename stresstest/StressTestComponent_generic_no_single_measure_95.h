...
#ifndef STRESSTEST_StressTestComponent95_H_
#define STRESSTEST_StressTestComponent95_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent95,StressTestComponent95, public ConsoleApplication)
public:
	StressTestComponent95();
	...
	static StressTestComponent95 mInstance;
...
#endif /* STRESSTEST_StressTestComponent95_H_ */
