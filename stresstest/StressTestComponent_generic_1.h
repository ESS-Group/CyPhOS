/*
 * StressTestComponent1.h
 *
 *  Created on: 09.03.2017
 *      Author: hendrik
 */

#ifndef STRESSTEST_StressTestComponent1_H_
#define STRESSTEST_StressTestComponent1_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent1,StressTestComponent1, public ConsoleApplication)
public:
	StressTestComponent1();
	...
	static StressTestComponent1 mInstance;
...
#endif /* STRESSTEST_StressTestComponent1_H_ */
