...
#include "StressTestComponent_generic_29.h"

#define TAG "StressTestComponent28"
...
BEGIN_OSC_IMPLEMENTATION(StressTestComponent28,StressTestComponent28)

StressTestComponent28 StressTestComponent28::mInstance;

SECTION_CRITICAL_DATA OSC* StressTestComponent28::trigger_deps_doStress[] = {nullptr};

SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent28::trigger_doStress = {(OSC*)&StressTestComponent28::mInstance,(void (OSC::*)(dword_t))&StressTestComponent28::func_doStress,
				(OSC**)&StressTestComponent28::trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 28 + 1,0x0};

SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent28::trigger_subscribe = {(OSC*)&StressTestComponent28::mInstance,(void (OSC::*)(dword_t))&StressTestComponent28::func_subscribe,
				(OSC**)&StressTestComponent28::trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 28 + 2};

SECTION_CRITICAL_DATA OSC* StressTestComponent28::trigger_deps_printOut[] = {CONSOLE_BUFFER_DEP,nullptr};
SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent28::trigger_printOut = {(OSC*)&StressTestComponent28::mInstance,(void (OSC::*)(dword_t))&StressTestComponent28::func_printOut,
				(OSC**)&StressTestComponent28::trigger_deps_printOut, EventHandling::Trigger::cMIN_Priority + 21000 + 28 + 3};

SECTION_CRITICAL_DATA EventHandling::Event StressTestComponent28::event_Continue;

SECTION_CRITICAL_DATA DEFINE_TRIGGER(StressTestComponent28,selfCall,StressTestComponent28::mInstance,trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 2003);


StressTestComponent28::StressTestComponent28() : mIterations(0), mMin(0xFFFFFFFF), mMax(0) {
//	EventHandling::EventHandler::pInstance.subscribeEvent(&OSC_PREFIX(StressTestComponent29)::StressTestComponent29::event_Continue, &trigger_doStress);
}

void StressTestComponent28::func_doStress(dword_t arg) {
...
void StressTestComponent28::func_printOut(dword_t arg) {
...
void StressTestComponent28::func_subscribe(dword_t arg) {
//	EventHandling::EventHandler::pInstance.subscribeEvent(&OSC_PREFIX(StressTestComponent29)::StressTestComponent29::event_Continue, &trigger_doStress);
	EventHandling::EventHandler::pInstance.eventTriggered(&event_Continue,0);
}

DEFINE_TRIGGER_FUNC(StressTestComponent28,selfCall) {
	mIterations++;
