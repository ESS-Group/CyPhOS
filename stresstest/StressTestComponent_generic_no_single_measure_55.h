...
#ifndef STRESSTEST_StressTestComponent55_H_
#define STRESSTEST_StressTestComponent55_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent55,StressTestComponent55, public ConsoleApplication)
public:
	StressTestComponent55();
	...
	static StressTestComponent55 mInstance;
...
#endif /* STRESSTEST_StressTestComponent55_H_ */
