...
#ifndef STRESSTEST_StressTestComponent58_H_
#define STRESSTEST_StressTestComponent58_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent58,StressTestComponent58, public ConsoleApplication)
public:
	StressTestComponent58();
	...
	static StressTestComponent58 mInstance;
...
#endif /* STRESSTEST_StressTestComponent58_H_ */
