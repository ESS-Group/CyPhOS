...
#ifndef STRESSTEST_StressTestComponent119_H_
#define STRESSTEST_StressTestComponent119_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent119,StressTestComponent119, public ConsoleApplication)
public:
	StressTestComponent119();
	...
	static StressTestComponent119 mInstance;
...
#endif /* STRESSTEST_StressTestComponent119_H_ */
