/*
 * StressTestComponent9.h
 *
 *  Created on: 09.03.2017
 *      Author: hendrik
 */

#ifndef STRESSTEST_StressTestComponent9_H_
#define STRESSTEST_StressTestComponent9_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent9,StressTestComponent9, public ConsoleApplication)
public:
	StressTestComponent9();
	...
	static StressTestComponent9 mInstance;
...
#endif /* STRESSTEST_StressTestComponent9_H_ */
