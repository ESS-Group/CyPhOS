...
#ifndef STRESSTEST_StressTestComponent89_H_
#define STRESSTEST_StressTestComponent89_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent89,StressTestComponent89, public ConsoleApplication)
public:
	StressTestComponent89();
	...
	static StressTestComponent89 mInstance;
...
#endif /* STRESSTEST_StressTestComponent89_H_ */
