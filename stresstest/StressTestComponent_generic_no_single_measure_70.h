...
#ifndef STRESSTEST_StressTestComponent70_H_
#define STRESSTEST_StressTestComponent70_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent70,StressTestComponent70, public ConsoleApplication)
public:
	StressTestComponent70();
	...
	static StressTestComponent70 mInstance;
...
#endif /* STRESSTEST_StressTestComponent70_H_ */
