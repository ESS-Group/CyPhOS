...
#ifndef STRESSTEST_StressTestComponent108_H_
#define STRESSTEST_StressTestComponent108_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent108,StressTestComponent108, public ConsoleApplication)
public:
	StressTestComponent108();
	...
	static StressTestComponent108 mInstance;
...
#endif /* STRESSTEST_StressTestComponent108_H_ */
