...
#ifndef STRESSTEST_StressTestComponent83_H_
#define STRESSTEST_StressTestComponent83_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent83,StressTestComponent83, public ConsoleApplication)
public:
	StressTestComponent83();
	...
	static StressTestComponent83 mInstance;
...
#endif /* STRESSTEST_StressTestComponent83_H_ */
