...
#include "StressTestComponent_generic_27.h"

#define TAG "StressTestComponent26"
...
BEGIN_OSC_IMPLEMENTATION(StressTestComponent26,StressTestComponent26)

StressTestComponent26 StressTestComponent26::mInstance;

SECTION_CRITICAL_DATA OSC* StressTestComponent26::trigger_deps_doStress[] = {nullptr};

SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent26::trigger_doStress = {(OSC*)&StressTestComponent26::mInstance,(void (OSC::*)(dword_t))&StressTestComponent26::func_doStress,
				(OSC**)&StressTestComponent26::trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 26 + 1,0x0};

SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent26::trigger_subscribe = {(OSC*)&StressTestComponent26::mInstance,(void (OSC::*)(dword_t))&StressTestComponent26::func_subscribe,
				(OSC**)&StressTestComponent26::trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 26 + 2};

SECTION_CRITICAL_DATA OSC* StressTestComponent26::trigger_deps_printOut[] = {CONSOLE_BUFFER_DEP,nullptr};
SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent26::trigger_printOut = {(OSC*)&StressTestComponent26::mInstance,(void (OSC::*)(dword_t))&StressTestComponent26::func_printOut,
				(OSC**)&StressTestComponent26::trigger_deps_printOut, EventHandling::Trigger::cMIN_Priority + 21000 + 26 + 3};

SECTION_CRITICAL_DATA EventHandling::Event StressTestComponent26::event_Continue;

SECTION_CRITICAL_DATA DEFINE_TRIGGER(StressTestComponent26,selfCall,StressTestComponent26::mInstance,trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 2003);


StressTestComponent26::StressTestComponent26() : mIterations(0), mMin(0xFFFFFFFF), mMax(0) {
//	EventHandling::EventHandler::pInstance.subscribeEvent(&OSC_PREFIX(StressTestComponent27)::StressTestComponent27::event_Continue, &trigger_doStress);
}

void StressTestComponent26::func_doStress(dword_t arg) {
...
void StressTestComponent26::func_printOut(dword_t arg) {
...
void StressTestComponent26::func_subscribe(dword_t arg) {
//	EventHandling::EventHandler::pInstance.subscribeEvent(&OSC_PREFIX(StressTestComponent27)::StressTestComponent27::event_Continue, &trigger_doStress);
	EventHandling::EventHandler::pInstance.eventTriggered(&event_Continue,0);
}

DEFINE_TRIGGER_FUNC(StressTestComponent26,selfCall) {
	mIterations++;
