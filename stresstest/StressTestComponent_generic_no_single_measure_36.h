...
#ifndef STRESSTEST_StressTestComponent36_H_
#define STRESSTEST_StressTestComponent36_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent36,StressTestComponent36, public ConsoleApplication)
public:
	StressTestComponent36();
	...
	static StressTestComponent36 mInstance;
...
#endif /* STRESSTEST_StressTestComponent36_H_ */
