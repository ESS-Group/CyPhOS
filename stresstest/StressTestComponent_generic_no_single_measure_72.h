...
#ifndef STRESSTEST_StressTestComponent72_H_
#define STRESSTEST_StressTestComponent72_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent72,StressTestComponent72, public ConsoleApplication)
public:
	StressTestComponent72();
	...
	static StressTestComponent72 mInstance;
...
#endif /* STRESSTEST_StressTestComponent72_H_ */
