...
#ifndef STRESSTEST_StressTestComponent121_H_
#define STRESSTEST_StressTestComponent121_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent121,StressTestComponent121, public ConsoleApplication)
public:
	StressTestComponent121();
	...
	static StressTestComponent121 mInstance;
...
#endif /* STRESSTEST_StressTestComponent121_H_ */
