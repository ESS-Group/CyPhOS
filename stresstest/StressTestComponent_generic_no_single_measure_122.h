...
#ifndef STRESSTEST_StressTestComponent122_H_
#define STRESSTEST_StressTestComponent122_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent122,StressTestComponent122, public ConsoleApplication)
public:
	StressTestComponent122();
	...
	static StressTestComponent122 mInstance;
...
#endif /* STRESSTEST_StressTestComponent122_H_ */
