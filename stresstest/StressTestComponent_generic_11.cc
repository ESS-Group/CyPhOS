...
#include "StressTestComponent_generic_12.h"

#define TAG "StressTestComponent11"
...
BEGIN_OSC_IMPLEMENTATION(StressTestComponent11,StressTestComponent11)

StressTestComponent11 StressTestComponent11::mInstance;

SECTION_CRITICAL_DATA OSC* StressTestComponent11::trigger_deps_doStress[] = {nullptr};

SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent11::trigger_doStress = {(OSC*)&StressTestComponent11::mInstance,(void (OSC::*)(dword_t))&StressTestComponent11::func_doStress,
				(OSC**)&StressTestComponent11::trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 11 + 1,0x0};

SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent11::trigger_subscribe = {(OSC*)&StressTestComponent11::mInstance,(void (OSC::*)(dword_t))&StressTestComponent11::func_subscribe,
				(OSC**)&StressTestComponent11::trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 11 + 2};

SECTION_CRITICAL_DATA OSC* StressTestComponent11::trigger_deps_printOut[] = {CONSOLE_BUFFER_DEP,nullptr};
SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent11::trigger_printOut = {(OSC*)&StressTestComponent11::mInstance,(void (OSC::*)(dword_t))&StressTestComponent11::func_printOut,
				(OSC**)&StressTestComponent11::trigger_deps_printOut, EventHandling::Trigger::cMIN_Priority + 21000 + 11 + 3};

SECTION_CRITICAL_DATA EventHandling::Event StressTestComponent11::event_Continue;

SECTION_CRITICAL_DATA DEFINE_TRIGGER(StressTestComponent11,selfCall,StressTestComponent11::mInstance,trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 2003);


StressTestComponent11::StressTestComponent11() : mIterations(0), mMin(0xFFFFFFFF), mMax(0) {
//	EventHandling::EventHandler::pInstance.subscribeEvent(&OSC_PREFIX(StressTestComponent12)::StressTestComponent12::event_Continue, &trigger_doStress);
}

void StressTestComponent11::func_doStress(dword_t arg) {
...
void StressTestComponent11::func_printOut(dword_t arg) {
...
void StressTestComponent11::func_subscribe(dword_t arg) {
//	EventHandling::EventHandler::pInstance.subscribeEvent(&OSC_PREFIX(StressTestComponent12)::StressTestComponent12::event_Continue, &trigger_doStress);
	EventHandling::EventHandler::pInstance.eventTriggered(&event_Continue,0);
}

DEFINE_TRIGGER_FUNC(StressTestComponent11,selfCall) {
	mIterations++;
