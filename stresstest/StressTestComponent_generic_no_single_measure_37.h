...
#ifndef STRESSTEST_StressTestComponent37_H_
#define STRESSTEST_StressTestComponent37_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent37,StressTestComponent37, public ConsoleApplication)
public:
	StressTestComponent37();
	...
	static StressTestComponent37 mInstance;
...
#endif /* STRESSTEST_StressTestComponent37_H_ */
