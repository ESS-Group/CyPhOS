...
#ifndef STRESSTEST_StressTestComponent115_H_
#define STRESSTEST_StressTestComponent115_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent115,StressTestComponent115, public ConsoleApplication)
public:
	StressTestComponent115();
	...
	static StressTestComponent115 mInstance;
...
#endif /* STRESSTEST_StressTestComponent115_H_ */
