...
#ifndef STRESSTEST_StressTestComponent86_H_
#define STRESSTEST_StressTestComponent86_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent86,StressTestComponent86, public ConsoleApplication)
public:
	StressTestComponent86();
	...
	static StressTestComponent86 mInstance;
...
#endif /* STRESSTEST_StressTestComponent86_H_ */
