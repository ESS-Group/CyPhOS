/*
 * StressTestComponent5.h
 *
 *  Created on: 09.03.2017
 *      Author: hendrik
 */

#ifndef STRESSTEST_StressTestComponent5_H_
#define STRESSTEST_StressTestComponent5_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent5,StressTestComponent5, public ConsoleApplication)
public:
	StressTestComponent5();
	...
	static StressTestComponent5 mInstance;
...
#endif /* STRESSTEST_StressTestComponent5_H_ */
