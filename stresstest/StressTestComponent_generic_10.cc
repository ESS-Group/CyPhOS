...
#include "StressTestComponent_generic_11.h"

#define TAG "StressTestComponent10"
...
BEGIN_OSC_IMPLEMENTATION(StressTestComponent10,StressTestComponent10)

StressTestComponent10 StressTestComponent10::mInstance;

SECTION_CRITICAL_DATA OSC* StressTestComponent10::trigger_deps_doStress[] = {nullptr};

SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent10::trigger_doStress = {(OSC*)&StressTestComponent10::mInstance,(void (OSC::*)(dword_t))&StressTestComponent10::func_doStress,
				(OSC**)&StressTestComponent10::trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 10 + 1,0x0};

SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent10::trigger_subscribe = {(OSC*)&StressTestComponent10::mInstance,(void (OSC::*)(dword_t))&StressTestComponent10::func_subscribe,
				(OSC**)&StressTestComponent10::trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 10 + 2};

SECTION_CRITICAL_DATA OSC* StressTestComponent10::trigger_deps_printOut[] = {CONSOLE_BUFFER_DEP,nullptr};
SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent10::trigger_printOut = {(OSC*)&StressTestComponent10::mInstance,(void (OSC::*)(dword_t))&StressTestComponent10::func_printOut,
				(OSC**)&StressTestComponent10::trigger_deps_printOut, EventHandling::Trigger::cMIN_Priority + 21000 + 10 + 3};

SECTION_CRITICAL_DATA EventHandling::Event StressTestComponent10::event_Continue;

SECTION_CRITICAL_DATA DEFINE_TRIGGER(StressTestComponent10,selfCall,StressTestComponent10::mInstance,trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 2003);


StressTestComponent10::StressTestComponent10() : mIterations(0), mMin(0xFFFFFFFF), mMax(0) {
//	EventHandling::EventHandler::pInstance.subscribeEvent(&OSC_PREFIX(StressTestComponent11)::StressTestComponent11::event_Continue, &trigger_doStress);
}

void StressTestComponent10::func_doStress(dword_t arg) {
...
void StressTestComponent10::func_printOut(dword_t arg) {
...
void StressTestComponent10::func_subscribe(dword_t arg) {
//	EventHandling::EventHandler::pInstance.subscribeEvent(&OSC_PREFIX(StressTestComponent11)::StressTestComponent11::event_Continue, &trigger_doStress);
	EventHandling::EventHandler::pInstance.eventTriggered(&event_Continue,0);
}

DEFINE_TRIGGER_FUNC(StressTestComponent10,selfCall) {
	mIterations++;
