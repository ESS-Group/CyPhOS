...
#ifndef STRESSTEST_StressTestComponent90_H_
#define STRESSTEST_StressTestComponent90_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent90,StressTestComponent90, public ConsoleApplication)
public:
	StressTestComponent90();
	...
	static StressTestComponent90 mInstance;
...
#endif /* STRESSTEST_StressTestComponent90_H_ */
