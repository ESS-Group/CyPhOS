...
#include "StressTestComponent_generic_18.h"

#define TAG "StressTestComponent17"
...
BEGIN_OSC_IMPLEMENTATION(StressTestComponent17,StressTestComponent17)

StressTestComponent17 StressTestComponent17::mInstance;

SECTION_CRITICAL_DATA OSC* StressTestComponent17::trigger_deps_doStress[] = {nullptr};

SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent17::trigger_doStress = {(OSC*)&StressTestComponent17::mInstance,(void (OSC::*)(dword_t))&StressTestComponent17::func_doStress,
				(OSC**)&StressTestComponent17::trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 17 + 1,0x0};

SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent17::trigger_subscribe = {(OSC*)&StressTestComponent17::mInstance,(void (OSC::*)(dword_t))&StressTestComponent17::func_subscribe,
				(OSC**)&StressTestComponent17::trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 17 + 2};

SECTION_CRITICAL_DATA OSC* StressTestComponent17::trigger_deps_printOut[] = {CONSOLE_BUFFER_DEP,nullptr};
SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent17::trigger_printOut = {(OSC*)&StressTestComponent17::mInstance,(void (OSC::*)(dword_t))&StressTestComponent17::func_printOut,
				(OSC**)&StressTestComponent17::trigger_deps_printOut, EventHandling::Trigger::cMIN_Priority + 21000 + 17 + 3};

SECTION_CRITICAL_DATA EventHandling::Event StressTestComponent17::event_Continue;

SECTION_CRITICAL_DATA DEFINE_TRIGGER(StressTestComponent17,selfCall,StressTestComponent17::mInstance,trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 2003);


StressTestComponent17::StressTestComponent17() : mIterations(0), mMin(0xFFFFFFFF), mMax(0) {
//	EventHandling::EventHandler::pInstance.subscribeEvent(&OSC_PREFIX(StressTestComponent18)::StressTestComponent18::event_Continue, &trigger_doStress);
}

void StressTestComponent17::func_doStress(dword_t arg) {
...
void StressTestComponent17::func_printOut(dword_t arg) {
...
void StressTestComponent17::func_subscribe(dword_t arg) {
//	EventHandling::EventHandler::pInstance.subscribeEvent(&OSC_PREFIX(StressTestComponent18)::StressTestComponent18::event_Continue, &trigger_doStress);
	EventHandling::EventHandler::pInstance.eventTriggered(&event_Continue,0);
}

DEFINE_TRIGGER_FUNC(StressTestComponent17,selfCall) {
	mIterations++;
