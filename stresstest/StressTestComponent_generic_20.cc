...
#include "StressTestComponent_generic_21.h"

#define TAG "StressTestComponent20"
...
BEGIN_OSC_IMPLEMENTATION(StressTestComponent20,StressTestComponent20)

StressTestComponent20 StressTestComponent20::mInstance;

SECTION_CRITICAL_DATA OSC* StressTestComponent20::trigger_deps_doStress[] = {nullptr};

SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent20::trigger_doStress = {(OSC*)&StressTestComponent20::mInstance,(void (OSC::*)(dword_t))&StressTestComponent20::func_doStress,
				(OSC**)&StressTestComponent20::trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 20 + 1,0x0};

SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent20::trigger_subscribe = {(OSC*)&StressTestComponent20::mInstance,(void (OSC::*)(dword_t))&StressTestComponent20::func_subscribe,
				(OSC**)&StressTestComponent20::trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 20 + 2};

SECTION_CRITICAL_DATA OSC* StressTestComponent20::trigger_deps_printOut[] = {CONSOLE_BUFFER_DEP,nullptr};
SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent20::trigger_printOut = {(OSC*)&StressTestComponent20::mInstance,(void (OSC::*)(dword_t))&StressTestComponent20::func_printOut,
				(OSC**)&StressTestComponent20::trigger_deps_printOut, EventHandling::Trigger::cMIN_Priority + 21000 + 20 + 3};

SECTION_CRITICAL_DATA EventHandling::Event StressTestComponent20::event_Continue;

SECTION_CRITICAL_DATA DEFINE_TRIGGER(StressTestComponent20,selfCall,StressTestComponent20::mInstance,trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 2003);


StressTestComponent20::StressTestComponent20() : mIterations(0), mMin(0xFFFFFFFF), mMax(0) {
//	EventHandling::EventHandler::pInstance.subscribeEvent(&OSC_PREFIX(StressTestComponent21)::StressTestComponent21::event_Continue, &trigger_doStress);
}

void StressTestComponent20::func_doStress(dword_t arg) {
...
void StressTestComponent20::func_printOut(dword_t arg) {
...
void StressTestComponent20::func_subscribe(dword_t arg) {
//	EventHandling::EventHandler::pInstance.subscribeEvent(&OSC_PREFIX(StressTestComponent21)::StressTestComponent21::event_Continue, &trigger_doStress);
	EventHandling::EventHandler::pInstance.eventTriggered(&event_Continue,0);
}

DEFINE_TRIGGER_FUNC(StressTestComponent20,selfCall) {
	mIterations++;
