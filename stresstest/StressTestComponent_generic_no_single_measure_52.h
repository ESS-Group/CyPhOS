...
#ifndef STRESSTEST_StressTestComponent52_H_
#define STRESSTEST_StressTestComponent52_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent52,StressTestComponent52, public ConsoleApplication)
public:
	StressTestComponent52();
	...
	static StressTestComponent52 mInstance;
...
#endif /* STRESSTEST_StressTestComponent52_H_ */
