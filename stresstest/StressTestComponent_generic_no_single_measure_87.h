...
#ifndef STRESSTEST_StressTestComponent87_H_
#define STRESSTEST_StressTestComponent87_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent87,StressTestComponent87, public ConsoleApplication)
public:
	StressTestComponent87();
	...
	static StressTestComponent87 mInstance;
...
#endif /* STRESSTEST_StressTestComponent87_H_ */
