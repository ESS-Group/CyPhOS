...
#include "StressTestComponent_generic_22.h"

#define TAG "StressTestComponent21"
...
BEGIN_OSC_IMPLEMENTATION(StressTestComponent21,StressTestComponent21)

StressTestComponent21 StressTestComponent21::mInstance;

SECTION_CRITICAL_DATA OSC* StressTestComponent21::trigger_deps_doStress[] = {nullptr};

SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent21::trigger_doStress = {(OSC*)&StressTestComponent21::mInstance,(void (OSC::*)(dword_t))&StressTestComponent21::func_doStress,
				(OSC**)&StressTestComponent21::trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 21 + 1,0x0};

SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent21::trigger_subscribe = {(OSC*)&StressTestComponent21::mInstance,(void (OSC::*)(dword_t))&StressTestComponent21::func_subscribe,
				(OSC**)&StressTestComponent21::trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 21 + 2};

SECTION_CRITICAL_DATA OSC* StressTestComponent21::trigger_deps_printOut[] = {CONSOLE_BUFFER_DEP,nullptr};
SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent21::trigger_printOut = {(OSC*)&StressTestComponent21::mInstance,(void (OSC::*)(dword_t))&StressTestComponent21::func_printOut,
				(OSC**)&StressTestComponent21::trigger_deps_printOut, EventHandling::Trigger::cMIN_Priority + 21000 + 21 + 3};

SECTION_CRITICAL_DATA EventHandling::Event StressTestComponent21::event_Continue;

SECTION_CRITICAL_DATA DEFINE_TRIGGER(StressTestComponent21,selfCall,StressTestComponent21::mInstance,trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 2003);


StressTestComponent21::StressTestComponent21() : mIterations(0), mMin(0xFFFFFFFF), mMax(0) {
//	EventHandling::EventHandler::pInstance.subscribeEvent(&OSC_PREFIX(StressTestComponent22)::StressTestComponent22::event_Continue, &trigger_doStress);
}

void StressTestComponent21::func_doStress(dword_t arg) {
...
void StressTestComponent21::func_printOut(dword_t arg) {
...
void StressTestComponent21::func_subscribe(dword_t arg) {
//	EventHandling::EventHandler::pInstance.subscribeEvent(&OSC_PREFIX(StressTestComponent22)::StressTestComponent22::event_Continue, &trigger_doStress);
	EventHandling::EventHandler::pInstance.eventTriggered(&event_Continue,0);
}

DEFINE_TRIGGER_FUNC(StressTestComponent21,selfCall) {
	mIterations++;
