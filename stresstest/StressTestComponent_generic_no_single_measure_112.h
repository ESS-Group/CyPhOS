...
#ifndef STRESSTEST_StressTestComponent112_H_
#define STRESSTEST_StressTestComponent112_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent112,StressTestComponent112, public ConsoleApplication)
public:
	StressTestComponent112();
	...
	static StressTestComponent112 mInstance;
...
#endif /* STRESSTEST_StressTestComponent112_H_ */
