...
#ifndef STRESSTEST_StressTestComponent47_H_
#define STRESSTEST_StressTestComponent47_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent47,StressTestComponent47, public ConsoleApplication)
public:
	StressTestComponent47();
	...
	static StressTestComponent47 mInstance;
...
#endif /* STRESSTEST_StressTestComponent47_H_ */
