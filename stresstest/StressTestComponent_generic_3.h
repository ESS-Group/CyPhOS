/*
 * StressTestComponent3.h
 *
 *  Created on: 09.03.2017
 *      Author: hendrik
 */

#ifndef STRESSTEST_StressTestComponent3_H_
#define STRESSTEST_StressTestComponent3_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent3,StressTestComponent3, public ConsoleApplication)
public:
	StressTestComponent3();
	...
	static StressTestComponent3 mInstance;
...
#endif /* STRESSTEST_StressTestComponent3_H_ */
