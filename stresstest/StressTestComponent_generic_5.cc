...
#include "StressTestComponent_generic_6.h"

#define TAG "StressTestComponent5"
...
BEGIN_OSC_IMPLEMENTATION(StressTestComponent5,StressTestComponent5)

StressTestComponent5 StressTestComponent5::mInstance;

SECTION_CRITICAL_DATA OSC* StressTestComponent5::trigger_deps_doStress[] = {nullptr};

SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent5::trigger_doStress = {(OSC*)&StressTestComponent5::mInstance,(void (OSC::*)(dword_t))&StressTestComponent5::func_doStress,
				(OSC**)&StressTestComponent5::trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 5 + 1,0x0};

SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent5::trigger_subscribe = {(OSC*)&StressTestComponent5::mInstance,(void (OSC::*)(dword_t))&StressTestComponent5::func_subscribe,
				(OSC**)&StressTestComponent5::trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 5 + 2};

SECTION_CRITICAL_DATA OSC* StressTestComponent5::trigger_deps_printOut[] = {CONSOLE_BUFFER_DEP,nullptr};
SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent5::trigger_printOut = {(OSC*)&StressTestComponent5::mInstance,(void (OSC::*)(dword_t))&StressTestComponent5::func_printOut,
				(OSC**)&StressTestComponent5::trigger_deps_printOut, EventHandling::Trigger::cMIN_Priority + 21000 + 5 + 3};

SECTION_CRITICAL_DATA EventHandling::Event StressTestComponent5::event_Continue;

SECTION_CRITICAL_DATA DEFINE_TRIGGER(StressTestComponent5,selfCall,StressTestComponent5::mInstance,trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 2003);


StressTestComponent5::StressTestComponent5() : mIterations(0), mMin(0xFFFFFFFF), mMax(0) {
//	EventHandling::EventHandler::pInstance.subscribeEvent(&OSC_PREFIX(StressTestComponent6)::StressTestComponent6::event_Continue, &trigger_doStress);
}

void StressTestComponent5::func_doStress(dword_t arg) {
...
void StressTestComponent5::func_printOut(dword_t arg) {
...
void StressTestComponent5::func_subscribe(dword_t arg) {
//	EventHandling::EventHandler::pInstance.subscribeEvent(&OSC_PREFIX(StressTestComponent6)::StressTestComponent6::event_Continue, &trigger_doStress);
	EventHandling::EventHandler::pInstance.eventTriggered(&event_Continue,0);
}

DEFINE_TRIGGER_FUNC(StressTestComponent5,selfCall) {
	mIterations++;
