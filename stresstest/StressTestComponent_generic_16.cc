...
#include "StressTestComponent_generic_17.h"

#define TAG "StressTestComponent16"
...
BEGIN_OSC_IMPLEMENTATION(StressTestComponent16,StressTestComponent16)

StressTestComponent16 StressTestComponent16::mInstance;

SECTION_CRITICAL_DATA OSC* StressTestComponent16::trigger_deps_doStress[] = {nullptr};

SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent16::trigger_doStress = {(OSC*)&StressTestComponent16::mInstance,(void (OSC::*)(dword_t))&StressTestComponent16::func_doStress,
				(OSC**)&StressTestComponent16::trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 16 + 1,0x0};

SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent16::trigger_subscribe = {(OSC*)&StressTestComponent16::mInstance,(void (OSC::*)(dword_t))&StressTestComponent16::func_subscribe,
				(OSC**)&StressTestComponent16::trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 16 + 2};

SECTION_CRITICAL_DATA OSC* StressTestComponent16::trigger_deps_printOut[] = {CONSOLE_BUFFER_DEP,nullptr};
SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent16::trigger_printOut = {(OSC*)&StressTestComponent16::mInstance,(void (OSC::*)(dword_t))&StressTestComponent16::func_printOut,
				(OSC**)&StressTestComponent16::trigger_deps_printOut, EventHandling::Trigger::cMIN_Priority + 21000 + 16 + 3};

SECTION_CRITICAL_DATA EventHandling::Event StressTestComponent16::event_Continue;

SECTION_CRITICAL_DATA DEFINE_TRIGGER(StressTestComponent16,selfCall,StressTestComponent16::mInstance,trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 2003);


StressTestComponent16::StressTestComponent16() : mIterations(0), mMin(0xFFFFFFFF), mMax(0) {
//	EventHandling::EventHandler::pInstance.subscribeEvent(&OSC_PREFIX(StressTestComponent17)::StressTestComponent17::event_Continue, &trigger_doStress);
}

void StressTestComponent16::func_doStress(dword_t arg) {
...
void StressTestComponent16::func_printOut(dword_t arg) {
...
void StressTestComponent16::func_subscribe(dword_t arg) {
//	EventHandling::EventHandler::pInstance.subscribeEvent(&OSC_PREFIX(StressTestComponent17)::StressTestComponent17::event_Continue, &trigger_doStress);
	EventHandling::EventHandler::pInstance.eventTriggered(&event_Continue,0);
}

DEFINE_TRIGGER_FUNC(StressTestComponent16,selfCall) {
	mIterations++;
