...
#ifndef STRESSTEST_StressTestComponent77_H_
#define STRESSTEST_StressTestComponent77_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent77,StressTestComponent77, public ConsoleApplication)
public:
	StressTestComponent77();
	...
	static StressTestComponent77 mInstance;
...
#endif /* STRESSTEST_StressTestComponent77_H_ */
