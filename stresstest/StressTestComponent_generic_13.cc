...
#include "StressTestComponent_generic_14.h"

#define TAG "StressTestComponent13"
...
BEGIN_OSC_IMPLEMENTATION(StressTestComponent13,StressTestComponent13)

StressTestComponent13 StressTestComponent13::mInstance;

SECTION_CRITICAL_DATA OSC* StressTestComponent13::trigger_deps_doStress[] = {nullptr};

SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent13::trigger_doStress = {(OSC*)&StressTestComponent13::mInstance,(void (OSC::*)(dword_t))&StressTestComponent13::func_doStress,
				(OSC**)&StressTestComponent13::trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 13 + 1,0x0};

SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent13::trigger_subscribe = {(OSC*)&StressTestComponent13::mInstance,(void (OSC::*)(dword_t))&StressTestComponent13::func_subscribe,
				(OSC**)&StressTestComponent13::trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 13 + 2};

SECTION_CRITICAL_DATA OSC* StressTestComponent13::trigger_deps_printOut[] = {CONSOLE_BUFFER_DEP,nullptr};
SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent13::trigger_printOut = {(OSC*)&StressTestComponent13::mInstance,(void (OSC::*)(dword_t))&StressTestComponent13::func_printOut,
				(OSC**)&StressTestComponent13::trigger_deps_printOut, EventHandling::Trigger::cMIN_Priority + 21000 + 13 + 3};

SECTION_CRITICAL_DATA EventHandling::Event StressTestComponent13::event_Continue;

SECTION_CRITICAL_DATA DEFINE_TRIGGER(StressTestComponent13,selfCall,StressTestComponent13::mInstance,trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 2003);


StressTestComponent13::StressTestComponent13() : mIterations(0), mMin(0xFFFFFFFF), mMax(0) {
//	EventHandling::EventHandler::pInstance.subscribeEvent(&OSC_PREFIX(StressTestComponent14)::StressTestComponent14::event_Continue, &trigger_doStress);
}

void StressTestComponent13::func_doStress(dword_t arg) {
...
void StressTestComponent13::func_printOut(dword_t arg) {
...
void StressTestComponent13::func_subscribe(dword_t arg) {
//	EventHandling::EventHandler::pInstance.subscribeEvent(&OSC_PREFIX(StressTestComponent14)::StressTestComponent14::event_Continue, &trigger_doStress);
	EventHandling::EventHandler::pInstance.eventTriggered(&event_Continue,0);
}

DEFINE_TRIGGER_FUNC(StressTestComponent13,selfCall) {
	mIterations++;
