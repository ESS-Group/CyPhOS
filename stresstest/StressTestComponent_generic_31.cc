...
#include "StressTestComponent_generic_0.h"

#define TAG "StressTestComponent31"
...
BEGIN_OSC_IMPLEMENTATION(StressTestComponent31,StressTestComponent31)

StressTestComponent31 StressTestComponent31::mInstance;

SECTION_CRITICAL_DATA OSC* StressTestComponent31::trigger_deps_doStress[] = {nullptr};

SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent31::trigger_doStress = {(OSC*)&StressTestComponent31::mInstance,(void (OSC::*)(dword_t))&StressTestComponent31::func_doStress,
				(OSC**)&StressTestComponent31::trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 31 + 1,0x0};

SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent31::trigger_subscribe = {(OSC*)&StressTestComponent31::mInstance,(void (OSC::*)(dword_t))&StressTestComponent31::func_subscribe,
				(OSC**)&StressTestComponent31::trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 31 + 2};

SECTION_CRITICAL_DATA OSC* StressTestComponent31::trigger_deps_printOut[] = {CONSOLE_BUFFER_DEP,nullptr};
SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent31::trigger_printOut = {(OSC*)&StressTestComponent31::mInstance,(void (OSC::*)(dword_t))&StressTestComponent31::func_printOut,
				(OSC**)&StressTestComponent31::trigger_deps_printOut, EventHandling::Trigger::cMIN_Priority + 21000 + 31 + 3};

SECTION_CRITICAL_DATA EventHandling::Event StressTestComponent31::event_Continue;

SECTION_CRITICAL_DATA DEFINE_TRIGGER(StressTestComponent31,selfCall,StressTestComponent31::mInstance,trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 2003);


StressTestComponent31::StressTestComponent31() : mIterations(0), mMin(0xFFFFFFFF), mMax(0) {
//	EventHandling::EventHandler::pInstance.subscribeEvent(&OSC_PREFIX(StressTestComponent0)::StressTestComponent0::event_Continue, &trigger_doStress);
}

void StressTestComponent31::func_doStress(dword_t arg) {
...
void StressTestComponent31::func_printOut(dword_t arg) {
...
void StressTestComponent31::func_subscribe(dword_t arg) {
//	EventHandling::EventHandler::pInstance.subscribeEvent(&OSC_PREFIX(StressTestComponent0)::StressTestComponent0::event_Continue, &trigger_doStress);
	EventHandling::EventHandler::pInstance.eventTriggered(&event_Continue,0);
}

DEFINE_TRIGGER_FUNC(StressTestComponent31,selfCall) {
	mIterations++;
