/*
 * StressTestComponent8.h
 *
 *  Created on: 09.03.2017
 *      Author: hendrik
 */

#ifndef STRESSTEST_StressTestComponent8_H_
#define STRESSTEST_StressTestComponent8_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent8,StressTestComponent8, public ConsoleApplication)
public:
	StressTestComponent8();
	...
	static StressTestComponent8 mInstance;
...
#endif /* STRESSTEST_StressTestComponent8_H_ */
