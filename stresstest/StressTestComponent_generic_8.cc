...
#include "StressTestComponent_generic_9.h"

#define TAG "StressTestComponent8"
...
BEGIN_OSC_IMPLEMENTATION(StressTestComponent8,StressTestComponent8)

StressTestComponent8 StressTestComponent8::mInstance;

SECTION_CRITICAL_DATA OSC* StressTestComponent8::trigger_deps_doStress[] = {nullptr};

SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent8::trigger_doStress = {(OSC*)&StressTestComponent8::mInstance,(void (OSC::*)(dword_t))&StressTestComponent8::func_doStress,
				(OSC**)&StressTestComponent8::trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 8 + 1,0x0};

SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent8::trigger_subscribe = {(OSC*)&StressTestComponent8::mInstance,(void (OSC::*)(dword_t))&StressTestComponent8::func_subscribe,
				(OSC**)&StressTestComponent8::trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 8 + 2};

SECTION_CRITICAL_DATA OSC* StressTestComponent8::trigger_deps_printOut[] = {CONSOLE_BUFFER_DEP,nullptr};
SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent8::trigger_printOut = {(OSC*)&StressTestComponent8::mInstance,(void (OSC::*)(dword_t))&StressTestComponent8::func_printOut,
				(OSC**)&StressTestComponent8::trigger_deps_printOut, EventHandling::Trigger::cMIN_Priority + 21000 + 8 + 3};

SECTION_CRITICAL_DATA EventHandling::Event StressTestComponent8::event_Continue;

SECTION_CRITICAL_DATA DEFINE_TRIGGER(StressTestComponent8,selfCall,StressTestComponent8::mInstance,trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 2003);


StressTestComponent8::StressTestComponent8() : mIterations(0), mMin(0xFFFFFFFF), mMax(0) {
//	EventHandling::EventHandler::pInstance.subscribeEvent(&OSC_PREFIX(StressTestComponent9)::StressTestComponent9::event_Continue, &trigger_doStress);
}

void StressTestComponent8::func_doStress(dword_t arg) {
...
void StressTestComponent8::func_printOut(dword_t arg) {
...
void StressTestComponent8::func_subscribe(dword_t arg) {
//	EventHandling::EventHandler::pInstance.subscribeEvent(&OSC_PREFIX(StressTestComponent9)::StressTestComponent9::event_Continue, &trigger_doStress);
	EventHandling::EventHandler::pInstance.eventTriggered(&event_Continue,0);
}

DEFINE_TRIGGER_FUNC(StressTestComponent8,selfCall) {
	mIterations++;
