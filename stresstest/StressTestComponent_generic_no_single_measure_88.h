...
#ifndef STRESSTEST_StressTestComponent88_H_
#define STRESSTEST_StressTestComponent88_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent88,StressTestComponent88, public ConsoleApplication)
public:
	StressTestComponent88();
	...
	static StressTestComponent88 mInstance;
...
#endif /* STRESSTEST_StressTestComponent88_H_ */
