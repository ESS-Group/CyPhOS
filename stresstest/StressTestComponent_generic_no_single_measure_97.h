...
#ifndef STRESSTEST_StressTestComponent97_H_
#define STRESSTEST_StressTestComponent97_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent97,StressTestComponent97, public ConsoleApplication)
public:
	StressTestComponent97();
	...
	static StressTestComponent97 mInstance;
...
#endif /* STRESSTEST_StressTestComponent97_H_ */
