...
#ifndef STRESSTEST_StressTestComponent104_H_
#define STRESSTEST_StressTestComponent104_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent104,StressTestComponent104, public ConsoleApplication)
public:
	StressTestComponent104();
	...
	static StressTestComponent104 mInstance;
...
#endif /* STRESSTEST_StressTestComponent104_H_ */
