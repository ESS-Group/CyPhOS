...
#ifndef STRESSTEST_StressTestComponent102_H_
#define STRESSTEST_StressTestComponent102_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent102,StressTestComponent102, public ConsoleApplication)
public:
	StressTestComponent102();
	...
	static StressTestComponent102 mInstance;
...
#endif /* STRESSTEST_StressTestComponent102_H_ */
