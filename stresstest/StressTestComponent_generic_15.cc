...
#include "StressTestComponent_generic_16.h"

#define TAG "StressTestComponent15"
...
BEGIN_OSC_IMPLEMENTATION(StressTestComponent15,StressTestComponent15)

StressTestComponent15 StressTestComponent15::mInstance;

SECTION_CRITICAL_DATA OSC* StressTestComponent15::trigger_deps_doStress[] = {nullptr};

SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent15::trigger_doStress = {(OSC*)&StressTestComponent15::mInstance,(void (OSC::*)(dword_t))&StressTestComponent15::func_doStress,
				(OSC**)&StressTestComponent15::trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 15 + 1,0x0};

SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent15::trigger_subscribe = {(OSC*)&StressTestComponent15::mInstance,(void (OSC::*)(dword_t))&StressTestComponent15::func_subscribe,
				(OSC**)&StressTestComponent15::trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 15 + 2};

SECTION_CRITICAL_DATA OSC* StressTestComponent15::trigger_deps_printOut[] = {CONSOLE_BUFFER_DEP,nullptr};
SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent15::trigger_printOut = {(OSC*)&StressTestComponent15::mInstance,(void (OSC::*)(dword_t))&StressTestComponent15::func_printOut,
				(OSC**)&StressTestComponent15::trigger_deps_printOut, EventHandling::Trigger::cMIN_Priority + 21000 + 15 + 3};

SECTION_CRITICAL_DATA EventHandling::Event StressTestComponent15::event_Continue;

SECTION_CRITICAL_DATA DEFINE_TRIGGER(StressTestComponent15,selfCall,StressTestComponent15::mInstance,trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 2003);


StressTestComponent15::StressTestComponent15() : mIterations(0), mMin(0xFFFFFFFF), mMax(0) {
//	EventHandling::EventHandler::pInstance.subscribeEvent(&OSC_PREFIX(StressTestComponent16)::StressTestComponent16::event_Continue, &trigger_doStress);
}

void StressTestComponent15::func_doStress(dword_t arg) {
...
void StressTestComponent15::func_printOut(dword_t arg) {
...
void StressTestComponent15::func_subscribe(dword_t arg) {
//	EventHandling::EventHandler::pInstance.subscribeEvent(&OSC_PREFIX(StressTestComponent16)::StressTestComponent16::event_Continue, &trigger_doStress);
	EventHandling::EventHandler::pInstance.eventTriggered(&event_Continue,0);
}

DEFINE_TRIGGER_FUNC(StressTestComponent15,selfCall) {
	mIterations++;
