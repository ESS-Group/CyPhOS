...
#include "StressTestComponent_generic_13.h"

#define TAG "StressTestComponent12"
...
BEGIN_OSC_IMPLEMENTATION(StressTestComponent12,StressTestComponent12)

StressTestComponent12 StressTestComponent12::mInstance;

SECTION_CRITICAL_DATA OSC* StressTestComponent12::trigger_deps_doStress[] = {nullptr};

SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent12::trigger_doStress = {(OSC*)&StressTestComponent12::mInstance,(void (OSC::*)(dword_t))&StressTestComponent12::func_doStress,
				(OSC**)&StressTestComponent12::trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 12 + 1,0x0};

SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent12::trigger_subscribe = {(OSC*)&StressTestComponent12::mInstance,(void (OSC::*)(dword_t))&StressTestComponent12::func_subscribe,
				(OSC**)&StressTestComponent12::trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 12 + 2};

SECTION_CRITICAL_DATA OSC* StressTestComponent12::trigger_deps_printOut[] = {CONSOLE_BUFFER_DEP,nullptr};
SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent12::trigger_printOut = {(OSC*)&StressTestComponent12::mInstance,(void (OSC::*)(dword_t))&StressTestComponent12::func_printOut,
				(OSC**)&StressTestComponent12::trigger_deps_printOut, EventHandling::Trigger::cMIN_Priority + 21000 + 12 + 3};

SECTION_CRITICAL_DATA EventHandling::Event StressTestComponent12::event_Continue;

SECTION_CRITICAL_DATA DEFINE_TRIGGER(StressTestComponent12,selfCall,StressTestComponent12::mInstance,trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 2003);


StressTestComponent12::StressTestComponent12() : mIterations(0), mMin(0xFFFFFFFF), mMax(0) {
//	EventHandling::EventHandler::pInstance.subscribeEvent(&OSC_PREFIX(StressTestComponent13)::StressTestComponent13::event_Continue, &trigger_doStress);
}

void StressTestComponent12::func_doStress(dword_t arg) {
...
void StressTestComponent12::func_printOut(dword_t arg) {
...
void StressTestComponent12::func_subscribe(dword_t arg) {
//	EventHandling::EventHandler::pInstance.subscribeEvent(&OSC_PREFIX(StressTestComponent13)::StressTestComponent13::event_Continue, &trigger_doStress);
	EventHandling::EventHandler::pInstance.eventTriggered(&event_Continue,0);
}

DEFINE_TRIGGER_FUNC(StressTestComponent12,selfCall) {
	mIterations++;
