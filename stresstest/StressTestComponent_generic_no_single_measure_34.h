...
#ifndef STRESSTEST_StressTestComponent34_H_
#define STRESSTEST_StressTestComponent34_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent34,StressTestComponent34, public ConsoleApplication)
public:
	StressTestComponent34();
	...
	static StressTestComponent34 mInstance;
...
#endif /* STRESSTEST_StressTestComponent34_H_ */
