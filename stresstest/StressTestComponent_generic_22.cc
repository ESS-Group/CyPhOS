...
#include "StressTestComponent_generic_23.h"

#define TAG "StressTestComponent22"
...
BEGIN_OSC_IMPLEMENTATION(StressTestComponent22,StressTestComponent22)

StressTestComponent22 StressTestComponent22::mInstance;

SECTION_CRITICAL_DATA OSC* StressTestComponent22::trigger_deps_doStress[] = {nullptr};

SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent22::trigger_doStress = {(OSC*)&StressTestComponent22::mInstance,(void (OSC::*)(dword_t))&StressTestComponent22::func_doStress,
				(OSC**)&StressTestComponent22::trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 22 + 1,0x0};

SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent22::trigger_subscribe = {(OSC*)&StressTestComponent22::mInstance,(void (OSC::*)(dword_t))&StressTestComponent22::func_subscribe,
				(OSC**)&StressTestComponent22::trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 22 + 2};

SECTION_CRITICAL_DATA OSC* StressTestComponent22::trigger_deps_printOut[] = {CONSOLE_BUFFER_DEP,nullptr};
SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent22::trigger_printOut = {(OSC*)&StressTestComponent22::mInstance,(void (OSC::*)(dword_t))&StressTestComponent22::func_printOut,
				(OSC**)&StressTestComponent22::trigger_deps_printOut, EventHandling::Trigger::cMIN_Priority + 21000 + 22 + 3};

SECTION_CRITICAL_DATA EventHandling::Event StressTestComponent22::event_Continue;

SECTION_CRITICAL_DATA DEFINE_TRIGGER(StressTestComponent22,selfCall,StressTestComponent22::mInstance,trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 2003);


StressTestComponent22::StressTestComponent22() : mIterations(0), mMin(0xFFFFFFFF), mMax(0) {
//	EventHandling::EventHandler::pInstance.subscribeEvent(&OSC_PREFIX(StressTestComponent23)::StressTestComponent23::event_Continue, &trigger_doStress);
}

void StressTestComponent22::func_doStress(dword_t arg) {
...
void StressTestComponent22::func_printOut(dword_t arg) {
...
void StressTestComponent22::func_subscribe(dword_t arg) {
//	EventHandling::EventHandler::pInstance.subscribeEvent(&OSC_PREFIX(StressTestComponent23)::StressTestComponent23::event_Continue, &trigger_doStress);
	EventHandling::EventHandler::pInstance.eventTriggered(&event_Continue,0);
}

DEFINE_TRIGGER_FUNC(StressTestComponent22,selfCall) {
	mIterations++;
