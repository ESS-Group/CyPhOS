/*
 * StressTestComponent6.h
 *
 *  Created on: 09.03.2017
 *      Author: hendrik
 */

#ifndef STRESSTEST_StressTestComponent6_H_
#define STRESSTEST_StressTestComponent6_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent6,StressTestComponent6, public ConsoleApplication)
public:
	StressTestComponent6();
	...
	static StressTestComponent6 mInstance;
...
#endif /* STRESSTEST_StressTestComponent6_H_ */
