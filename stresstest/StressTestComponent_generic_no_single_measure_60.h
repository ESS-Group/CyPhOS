...
#ifndef STRESSTEST_StressTestComponent60_H_
#define STRESSTEST_StressTestComponent60_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent60,StressTestComponent60, public ConsoleApplication)
public:
	StressTestComponent60();
	...
	static StressTestComponent60 mInstance;
...
#endif /* STRESSTEST_StressTestComponent60_H_ */
