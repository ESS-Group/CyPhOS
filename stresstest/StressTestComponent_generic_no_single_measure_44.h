...
#ifndef STRESSTEST_StressTestComponent44_H_
#define STRESSTEST_StressTestComponent44_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent44,StressTestComponent44, public ConsoleApplication)
public:
	StressTestComponent44();
	...
	static StressTestComponent44 mInstance;
...
#endif /* STRESSTEST_StressTestComponent44_H_ */
