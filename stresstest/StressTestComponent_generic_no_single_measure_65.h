...
#ifndef STRESSTEST_StressTestComponent65_H_
#define STRESSTEST_StressTestComponent65_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent65,StressTestComponent65, public ConsoleApplication)
public:
	StressTestComponent65();
	...
	static StressTestComponent65 mInstance;
...
#endif /* STRESSTEST_StressTestComponent65_H_ */
