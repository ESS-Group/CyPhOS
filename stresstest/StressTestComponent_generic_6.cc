...
#include "StressTestComponent_generic_7.h"

#define TAG "StressTestComponent6"
...
BEGIN_OSC_IMPLEMENTATION(StressTestComponent6,StressTestComponent6)

StressTestComponent6 StressTestComponent6::mInstance;

SECTION_CRITICAL_DATA OSC* StressTestComponent6::trigger_deps_doStress[] = {nullptr};

SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent6::trigger_doStress = {(OSC*)&StressTestComponent6::mInstance,(void (OSC::*)(dword_t))&StressTestComponent6::func_doStress,
				(OSC**)&StressTestComponent6::trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 6 + 1,0x0};

SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent6::trigger_subscribe = {(OSC*)&StressTestComponent6::mInstance,(void (OSC::*)(dword_t))&StressTestComponent6::func_subscribe,
				(OSC**)&StressTestComponent6::trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 6 + 2};

SECTION_CRITICAL_DATA OSC* StressTestComponent6::trigger_deps_printOut[] = {CONSOLE_BUFFER_DEP,nullptr};
SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent6::trigger_printOut = {(OSC*)&StressTestComponent6::mInstance,(void (OSC::*)(dword_t))&StressTestComponent6::func_printOut,
				(OSC**)&StressTestComponent6::trigger_deps_printOut, EventHandling::Trigger::cMIN_Priority + 21000 + 6 + 3};

SECTION_CRITICAL_DATA EventHandling::Event StressTestComponent6::event_Continue;

SECTION_CRITICAL_DATA DEFINE_TRIGGER(StressTestComponent6,selfCall,StressTestComponent6::mInstance,trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 2003);


StressTestComponent6::StressTestComponent6() : mIterations(0), mMin(0xFFFFFFFF), mMax(0) {
//	EventHandling::EventHandler::pInstance.subscribeEvent(&OSC_PREFIX(StressTestComponent7)::StressTestComponent7::event_Continue, &trigger_doStress);
}

void StressTestComponent6::func_doStress(dword_t arg) {
...
void StressTestComponent6::func_printOut(dword_t arg) {
...
void StressTestComponent6::func_subscribe(dword_t arg) {
//	EventHandling::EventHandler::pInstance.subscribeEvent(&OSC_PREFIX(StressTestComponent7)::StressTestComponent7::event_Continue, &trigger_doStress);
	EventHandling::EventHandler::pInstance.eventTriggered(&event_Continue,0);
}

DEFINE_TRIGGER_FUNC(StressTestComponent6,selfCall) {
	mIterations++;
