/*
 * StressTestComponent7.h
 *
 *  Created on: 09.03.2017
 *      Author: hendrik
 */

#ifndef STRESSTEST_StressTestComponent7_H_
#define STRESSTEST_StressTestComponent7_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent7,StressTestComponent7, public ConsoleApplication)
public:
	StressTestComponent7();
	...
	static StressTestComponent7 mInstance;
...
#endif /* STRESSTEST_StressTestComponent7_H_ */
