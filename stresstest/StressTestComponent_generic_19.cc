...
#include "StressTestComponent_generic_20.h"

#define TAG "StressTestComponent19"
...
BEGIN_OSC_IMPLEMENTATION(StressTestComponent19,StressTestComponent19)

StressTestComponent19 StressTestComponent19::mInstance;

SECTION_CRITICAL_DATA OSC* StressTestComponent19::trigger_deps_doStress[] = {nullptr};

SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent19::trigger_doStress = {(OSC*)&StressTestComponent19::mInstance,(void (OSC::*)(dword_t))&StressTestComponent19::func_doStress,
				(OSC**)&StressTestComponent19::trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 19 + 1,0x0};

SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent19::trigger_subscribe = {(OSC*)&StressTestComponent19::mInstance,(void (OSC::*)(dword_t))&StressTestComponent19::func_subscribe,
				(OSC**)&StressTestComponent19::trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 19 + 2};

SECTION_CRITICAL_DATA OSC* StressTestComponent19::trigger_deps_printOut[] = {CONSOLE_BUFFER_DEP,nullptr};
SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent19::trigger_printOut = {(OSC*)&StressTestComponent19::mInstance,(void (OSC::*)(dword_t))&StressTestComponent19::func_printOut,
				(OSC**)&StressTestComponent19::trigger_deps_printOut, EventHandling::Trigger::cMIN_Priority + 21000 + 19 + 3};

SECTION_CRITICAL_DATA EventHandling::Event StressTestComponent19::event_Continue;

SECTION_CRITICAL_DATA DEFINE_TRIGGER(StressTestComponent19,selfCall,StressTestComponent19::mInstance,trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 2003);


StressTestComponent19::StressTestComponent19() : mIterations(0), mMin(0xFFFFFFFF), mMax(0) {
//	EventHandling::EventHandler::pInstance.subscribeEvent(&OSC_PREFIX(StressTestComponent20)::StressTestComponent20::event_Continue, &trigger_doStress);
}

void StressTestComponent19::func_doStress(dword_t arg) {
...
void StressTestComponent19::func_printOut(dword_t arg) {
...
void StressTestComponent19::func_subscribe(dword_t arg) {
//	EventHandling::EventHandler::pInstance.subscribeEvent(&OSC_PREFIX(StressTestComponent20)::StressTestComponent20::event_Continue, &trigger_doStress);
	EventHandling::EventHandler::pInstance.eventTriggered(&event_Continue,0);
}

DEFINE_TRIGGER_FUNC(StressTestComponent19,selfCall) {
	mIterations++;
