...
#ifndef STRESSTEST_StressTestComponent67_H_
#define STRESSTEST_StressTestComponent67_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent67,StressTestComponent67, public ConsoleApplication)
public:
	StressTestComponent67();
	...
	static StressTestComponent67 mInstance;
...
#endif /* STRESSTEST_StressTestComponent67_H_ */
