...
#ifndef STRESSTEST_StressTestComponent107_H_
#define STRESSTEST_StressTestComponent107_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent107,StressTestComponent107, public ConsoleApplication)
public:
	StressTestComponent107();
	...
	static StressTestComponent107 mInstance;
...
#endif /* STRESSTEST_StressTestComponent107_H_ */
