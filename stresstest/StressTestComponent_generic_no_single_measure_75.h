...
#ifndef STRESSTEST_StressTestComponent75_H_
#define STRESSTEST_StressTestComponent75_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent75,StressTestComponent75, public ConsoleApplication)
public:
	StressTestComponent75();
	...
	static StressTestComponent75 mInstance;
...
#endif /* STRESSTEST_StressTestComponent75_H_ */
