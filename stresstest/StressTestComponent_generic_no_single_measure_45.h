...
#ifndef STRESSTEST_StressTestComponent45_H_
#define STRESSTEST_StressTestComponent45_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent45,StressTestComponent45, public ConsoleApplication)
public:
	StressTestComponent45();
	...
	static StressTestComponent45 mInstance;
...
#endif /* STRESSTEST_StressTestComponent45_H_ */
