...
#ifndef STRESSTEST_StressTestComponent54_H_
#define STRESSTEST_StressTestComponent54_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent54,StressTestComponent54, public ConsoleApplication)
public:
	StressTestComponent54();
	...
	static StressTestComponent54 mInstance;
...
#endif /* STRESSTEST_StressTestComponent54_H_ */
