...
#ifndef STRESSTEST_StressTestComponent71_H_
#define STRESSTEST_StressTestComponent71_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent71,StressTestComponent71, public ConsoleApplication)
public:
	StressTestComponent71();
	...
	static StressTestComponent71 mInstance;
...
#endif /* STRESSTEST_StressTestComponent71_H_ */
