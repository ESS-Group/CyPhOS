/*
 * StressTestComponent4.h
 *
 *  Created on: 09.03.2017
 *      Author: hendrik
 */

#ifndef STRESSTEST_StressTestComponent4_H_
#define STRESSTEST_StressTestComponent4_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent4,StressTestComponent4, public ConsoleApplication)
public:
	StressTestComponent4();
	...
	static StressTestComponent4 mInstance;
...
#endif /* STRESSTEST_StressTestComponent4_H_ */
