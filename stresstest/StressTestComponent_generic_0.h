...
#ifndef STRESSTEST_StressTestComponent0_H_
#define STRESSTEST_StressTestComponent0_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent0,StressTestComponent0, public ConsoleApplication)
public:
	StressTestComponent0();
	...
	static StressTestComponent0 mInstance;
...
#endif /* STRESSTEST_StressTestComponent0_H_ */
