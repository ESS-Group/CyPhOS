...
#ifndef STRESSTEST_StressTestComponent114_H_
#define STRESSTEST_StressTestComponent114_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent114,StressTestComponent114, public ConsoleApplication)
public:
	StressTestComponent114();
	...
	static StressTestComponent114 mInstance;
...
#endif /* STRESSTEST_StressTestComponent114_H_ */
