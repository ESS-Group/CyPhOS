...
#ifndef STRESSTEST_StressTestComponent40_H_
#define STRESSTEST_StressTestComponent40_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent40,StressTestComponent40, public ConsoleApplication)
public:
	StressTestComponent40();
	...
	static StressTestComponent40 mInstance;
...
#endif /* STRESSTEST_StressTestComponent40_H_ */
