...
#ifndef STRESSTEST_StressTestComponent93_H_
#define STRESSTEST_StressTestComponent93_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent93,StressTestComponent93, public ConsoleApplication)
public:
	StressTestComponent93();
	...
	static StressTestComponent93 mInstance;
...
#endif /* STRESSTEST_StressTestComponent93_H_ */
