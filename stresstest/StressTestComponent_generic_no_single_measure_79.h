...
#ifndef STRESSTEST_StressTestComponent79_H_
#define STRESSTEST_StressTestComponent79_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent79,StressTestComponent79, public ConsoleApplication)
public:
	StressTestComponent79();
	...
	static StressTestComponent79 mInstance;
...
#endif /* STRESSTEST_StressTestComponent79_H_ */
