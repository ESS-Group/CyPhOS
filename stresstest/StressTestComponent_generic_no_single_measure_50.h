...
#ifndef STRESSTEST_StressTestComponent50_H_
#define STRESSTEST_StressTestComponent50_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent50,StressTestComponent50, public ConsoleApplication)
public:
	StressTestComponent50();
	...
	static StressTestComponent50 mInstance;
...
#endif /* STRESSTEST_StressTestComponent50_H_ */
