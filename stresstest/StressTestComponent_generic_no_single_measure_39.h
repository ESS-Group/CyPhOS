...
#ifndef STRESSTEST_StressTestComponent39_H_
#define STRESSTEST_StressTestComponent39_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent39,StressTestComponent39, public ConsoleApplication)
public:
	StressTestComponent39();
	...
	static StressTestComponent39 mInstance;
...
#endif /* STRESSTEST_StressTestComponent39_H_ */
