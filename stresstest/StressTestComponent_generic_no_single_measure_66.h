...
#ifndef STRESSTEST_StressTestComponent66_H_
#define STRESSTEST_StressTestComponent66_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent66,StressTestComponent66, public ConsoleApplication)
public:
	StressTestComponent66();
	...
	static StressTestComponent66 mInstance;
...
#endif /* STRESSTEST_StressTestComponent66_H_ */
