...
#ifndef STRESSTEST_StressTestComponent111_H_
#define STRESSTEST_StressTestComponent111_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent111,StressTestComponent111, public ConsoleApplication)
public:
	StressTestComponent111();
	...
	static StressTestComponent111 mInstance;
...
#endif /* STRESSTEST_StressTestComponent111_H_ */
