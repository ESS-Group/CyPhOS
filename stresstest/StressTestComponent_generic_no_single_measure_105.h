...
#ifndef STRESSTEST_StressTestComponent105_H_
#define STRESSTEST_StressTestComponent105_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent105,StressTestComponent105, public ConsoleApplication)
public:
	StressTestComponent105();
	...
	static StressTestComponent105 mInstance;
...
#endif /* STRESSTEST_StressTestComponent105_H_ */
