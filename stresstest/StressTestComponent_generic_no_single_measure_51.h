...
#ifndef STRESSTEST_StressTestComponent51_H_
#define STRESSTEST_StressTestComponent51_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent51,StressTestComponent51, public ConsoleApplication)
public:
	StressTestComponent51();
	...
	static StressTestComponent51 mInstance;
...
#endif /* STRESSTEST_StressTestComponent51_H_ */
