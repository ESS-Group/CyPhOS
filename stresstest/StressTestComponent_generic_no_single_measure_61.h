...
#ifndef STRESSTEST_StressTestComponent61_H_
#define STRESSTEST_StressTestComponent61_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent61,StressTestComponent61, public ConsoleApplication)
public:
	StressTestComponent61();
	...
	static StressTestComponent61 mInstance;
...
#endif /* STRESSTEST_StressTestComponent61_H_ */
