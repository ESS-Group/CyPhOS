...
#ifndef STRESSTEST_StressTestComponent73_H_
#define STRESSTEST_StressTestComponent73_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent73,StressTestComponent73, public ConsoleApplication)
public:
	StressTestComponent73();
	...
	static StressTestComponent73 mInstance;
...
#endif /* STRESSTEST_StressTestComponent73_H_ */
