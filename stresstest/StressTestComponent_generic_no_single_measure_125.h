...
#ifndef STRESSTEST_StressTestComponent125_H_
#define STRESSTEST_StressTestComponent125_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent125,StressTestComponent125, public ConsoleApplication)
public:
	StressTestComponent125();
	...
	static StressTestComponent125 mInstance;
...
#endif /* STRESSTEST_StressTestComponent125_H_ */
