...
#ifndef STRESSTEST_StressTestComponent109_H_
#define STRESSTEST_StressTestComponent109_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent109,StressTestComponent109, public ConsoleApplication)
public:
	StressTestComponent109();
	...
	static StressTestComponent109 mInstance;
...
#endif /* STRESSTEST_StressTestComponent109_H_ */
