...
#include "StressTestComponent_generic_28.h"

#define TAG "StressTestComponent27"
...
BEGIN_OSC_IMPLEMENTATION(StressTestComponent27,StressTestComponent27)

StressTestComponent27 StressTestComponent27::mInstance;

SECTION_CRITICAL_DATA OSC* StressTestComponent27::trigger_deps_doStress[] = {nullptr};

SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent27::trigger_doStress = {(OSC*)&StressTestComponent27::mInstance,(void (OSC::*)(dword_t))&StressTestComponent27::func_doStress,
				(OSC**)&StressTestComponent27::trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 27 + 1,0x0};

SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent27::trigger_subscribe = {(OSC*)&StressTestComponent27::mInstance,(void (OSC::*)(dword_t))&StressTestComponent27::func_subscribe,
				(OSC**)&StressTestComponent27::trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 27 + 2};

SECTION_CRITICAL_DATA OSC* StressTestComponent27::trigger_deps_printOut[] = {CONSOLE_BUFFER_DEP,nullptr};
SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent27::trigger_printOut = {(OSC*)&StressTestComponent27::mInstance,(void (OSC::*)(dword_t))&StressTestComponent27::func_printOut,
				(OSC**)&StressTestComponent27::trigger_deps_printOut, EventHandling::Trigger::cMIN_Priority + 21000 + 27 + 3};

SECTION_CRITICAL_DATA EventHandling::Event StressTestComponent27::event_Continue;

SECTION_CRITICAL_DATA DEFINE_TRIGGER(StressTestComponent27,selfCall,StressTestComponent27::mInstance,trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 2003);


StressTestComponent27::StressTestComponent27() : mIterations(0), mMin(0xFFFFFFFF), mMax(0) {
//	EventHandling::EventHandler::pInstance.subscribeEvent(&OSC_PREFIX(StressTestComponent28)::StressTestComponent28::event_Continue, &trigger_doStress);
}

void StressTestComponent27::func_doStress(dword_t arg) {
...
void StressTestComponent27::func_printOut(dword_t arg) {
...
void StressTestComponent27::func_subscribe(dword_t arg) {
//	EventHandling::EventHandler::pInstance.subscribeEvent(&OSC_PREFIX(StressTestComponent28)::StressTestComponent28::event_Continue, &trigger_doStress);
	EventHandling::EventHandler::pInstance.eventTriggered(&event_Continue,0);
}

DEFINE_TRIGGER_FUNC(StressTestComponent27,selfCall) {
	mIterations++;
