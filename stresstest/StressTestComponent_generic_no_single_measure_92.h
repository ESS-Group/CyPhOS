...
#ifndef STRESSTEST_StressTestComponent92_H_
#define STRESSTEST_StressTestComponent92_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent92,StressTestComponent92, public ConsoleApplication)
public:
	StressTestComponent92();
	...
	static StressTestComponent92 mInstance;
...
#endif /* STRESSTEST_StressTestComponent92_H_ */
