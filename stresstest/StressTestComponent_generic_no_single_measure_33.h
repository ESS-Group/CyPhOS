...
#ifndef STRESSTEST_StressTestComponent33_H_
#define STRESSTEST_StressTestComponent33_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent33,StressTestComponent33, public ConsoleApplication)
public:
	StressTestComponent33();
	...
	static StressTestComponent33 mInstance;
...
#endif /* STRESSTEST_StressTestComponent33_H_ */
