...
#ifndef STRESSTEST_StressTestComponent35_H_
#define STRESSTEST_StressTestComponent35_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent35,StressTestComponent35, public ConsoleApplication)
public:
	StressTestComponent35();
	...
	static StressTestComponent35 mInstance;
...
#endif /* STRESSTEST_StressTestComponent35_H_ */
