...
#ifndef STRESSTEST_StressTestComponent117_H_
#define STRESSTEST_StressTestComponent117_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent117,StressTestComponent117, public ConsoleApplication)
public:
	StressTestComponent117();
	...
	static StressTestComponent117 mInstance;
...
#endif /* STRESSTEST_StressTestComponent117_H_ */
