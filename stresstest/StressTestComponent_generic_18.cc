...
#include "StressTestComponent_generic_19.h"

#define TAG "StressTestComponent18"
...
BEGIN_OSC_IMPLEMENTATION(StressTestComponent18,StressTestComponent18)

StressTestComponent18 StressTestComponent18::mInstance;

SECTION_CRITICAL_DATA OSC* StressTestComponent18::trigger_deps_doStress[] = {nullptr};

SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent18::trigger_doStress = {(OSC*)&StressTestComponent18::mInstance,(void (OSC::*)(dword_t))&StressTestComponent18::func_doStress,
				(OSC**)&StressTestComponent18::trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 18 + 1,0x0};

SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent18::trigger_subscribe = {(OSC*)&StressTestComponent18::mInstance,(void (OSC::*)(dword_t))&StressTestComponent18::func_subscribe,
				(OSC**)&StressTestComponent18::trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 18 + 2};

SECTION_CRITICAL_DATA OSC* StressTestComponent18::trigger_deps_printOut[] = {CONSOLE_BUFFER_DEP,nullptr};
SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent18::trigger_printOut = {(OSC*)&StressTestComponent18::mInstance,(void (OSC::*)(dword_t))&StressTestComponent18::func_printOut,
				(OSC**)&StressTestComponent18::trigger_deps_printOut, EventHandling::Trigger::cMIN_Priority + 21000 + 18 + 3};

SECTION_CRITICAL_DATA EventHandling::Event StressTestComponent18::event_Continue;

SECTION_CRITICAL_DATA DEFINE_TRIGGER(StressTestComponent18,selfCall,StressTestComponent18::mInstance,trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 2003);


StressTestComponent18::StressTestComponent18() : mIterations(0), mMin(0xFFFFFFFF), mMax(0) {
//	EventHandling::EventHandler::pInstance.subscribeEvent(&OSC_PREFIX(StressTestComponent19)::StressTestComponent19::event_Continue, &trigger_doStress);
}

void StressTestComponent18::func_doStress(dword_t arg) {
...
void StressTestComponent18::func_printOut(dword_t arg) {
...
void StressTestComponent18::func_subscribe(dword_t arg) {
//	EventHandling::EventHandler::pInstance.subscribeEvent(&OSC_PREFIX(StressTestComponent19)::StressTestComponent19::event_Continue, &trigger_doStress);
	EventHandling::EventHandler::pInstance.eventTriggered(&event_Continue,0);
}

DEFINE_TRIGGER_FUNC(StressTestComponent18,selfCall) {
	mIterations++;
