...
#include "StressTestComponent_generic_3.h"

#define TAG "StressTestComponent2"
...
BEGIN_OSC_IMPLEMENTATION(StressTestComponent2,StressTestComponent2)

StressTestComponent2 StressTestComponent2::mInstance;

SECTION_CRITICAL_DATA OSC* StressTestComponent2::trigger_deps_doStress[] = {nullptr};

SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent2::trigger_doStress = {(OSC*)&StressTestComponent2::mInstance,(void (OSC::*)(dword_t))&StressTestComponent2::func_doStress,
				(OSC**)&StressTestComponent2::trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 2 + 1,0x0};

SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent2::trigger_subscribe = {(OSC*)&StressTestComponent2::mInstance,(void (OSC::*)(dword_t))&StressTestComponent2::func_subscribe,
				(OSC**)&StressTestComponent2::trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 2 + 2};

SECTION_CRITICAL_DATA OSC* StressTestComponent2::trigger_deps_printOut[] = {CONSOLE_BUFFER_DEP,nullptr};
SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent2::trigger_printOut = {(OSC*)&StressTestComponent2::mInstance,(void (OSC::*)(dword_t))&StressTestComponent2::func_printOut,
				(OSC**)&StressTestComponent2::trigger_deps_printOut, EventHandling::Trigger::cMIN_Priority + 21000 + 2 + 3};

SECTION_CRITICAL_DATA EventHandling::Event StressTestComponent2::event_Continue;

SECTION_CRITICAL_DATA DEFINE_TRIGGER(StressTestComponent2,selfCall,StressTestComponent2::mInstance,trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 2003);


StressTestComponent2::StressTestComponent2() : mIterations(0), mMin(0xFFFFFFFF), mMax(0) {
//	EventHandling::EventHandler::pInstance.subscribeEvent(&OSC_PREFIX(StressTestComponent3)::StressTestComponent3::event_Continue, &trigger_doStress);
}

void StressTestComponent2::func_doStress(dword_t arg) {
...
void StressTestComponent2::func_printOut(dword_t arg) {
...
void StressTestComponent2::func_subscribe(dword_t arg) {
//	EventHandling::EventHandler::pInstance.subscribeEvent(&OSC_PREFIX(StressTestComponent3)::StressTestComponent3::event_Continue, &trigger_doStress);
	EventHandling::EventHandler::pInstance.eventTriggered(&event_Continue,0);
}

DEFINE_TRIGGER_FUNC(StressTestComponent2,selfCall) {
	mIterations++;
