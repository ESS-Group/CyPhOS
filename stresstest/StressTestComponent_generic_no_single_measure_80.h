...
#ifndef STRESSTEST_StressTestComponent80_H_
#define STRESSTEST_StressTestComponent80_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent80,StressTestComponent80, public ConsoleApplication)
public:
	StressTestComponent80();
	...
	static StressTestComponent80 mInstance;
...
#endif /* STRESSTEST_StressTestComponent80_H_ */
