...
#ifndef STRESSTEST_StressTestComponent100_H_
#define STRESSTEST_StressTestComponent100_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent100,StressTestComponent100, public ConsoleApplication)
public:
	StressTestComponent100();
	...
	static StressTestComponent100 mInstance;
...
#endif /* STRESSTEST_StressTestComponent100_H_ */
