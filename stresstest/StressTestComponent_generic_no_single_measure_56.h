...
#ifndef STRESSTEST_StressTestComponent56_H_
#define STRESSTEST_StressTestComponent56_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent56,StressTestComponent56, public ConsoleApplication)
public:
	StressTestComponent56();
	...
	static StressTestComponent56 mInstance;
...
#endif /* STRESSTEST_StressTestComponent56_H_ */
