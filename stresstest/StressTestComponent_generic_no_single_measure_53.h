...
#ifndef STRESSTEST_StressTestComponent53_H_
#define STRESSTEST_StressTestComponent53_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent53,StressTestComponent53, public ConsoleApplication)
public:
	StressTestComponent53();
	...
	static StressTestComponent53 mInstance;
...
#endif /* STRESSTEST_StressTestComponent53_H_ */
