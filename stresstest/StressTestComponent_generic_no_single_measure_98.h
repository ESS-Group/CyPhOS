...
#ifndef STRESSTEST_StressTestComponent98_H_
#define STRESSTEST_StressTestComponent98_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent98,StressTestComponent98, public ConsoleApplication)
public:
	StressTestComponent98();
	...
	static StressTestComponent98 mInstance;
...
#endif /* STRESSTEST_StressTestComponent98_H_ */
