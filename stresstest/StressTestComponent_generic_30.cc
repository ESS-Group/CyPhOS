...
#include "StressTestComponent_generic_31.h"

#define TAG "StressTestComponent30"
...
BEGIN_OSC_IMPLEMENTATION(StressTestComponent30,StressTestComponent30)

StressTestComponent30 StressTestComponent30::mInstance;

SECTION_CRITICAL_DATA OSC* StressTestComponent30::trigger_deps_doStress[] = {nullptr};

SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent30::trigger_doStress = {(OSC*)&StressTestComponent30::mInstance,(void (OSC::*)(dword_t))&StressTestComponent30::func_doStress,
				(OSC**)&StressTestComponent30::trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 30 + 1,0x0};

SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent30::trigger_subscribe = {(OSC*)&StressTestComponent30::mInstance,(void (OSC::*)(dword_t))&StressTestComponent30::func_subscribe,
				(OSC**)&StressTestComponent30::trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 30 + 2};

SECTION_CRITICAL_DATA OSC* StressTestComponent30::trigger_deps_printOut[] = {CONSOLE_BUFFER_DEP,nullptr};
SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent30::trigger_printOut = {(OSC*)&StressTestComponent30::mInstance,(void (OSC::*)(dword_t))&StressTestComponent30::func_printOut,
				(OSC**)&StressTestComponent30::trigger_deps_printOut, EventHandling::Trigger::cMIN_Priority + 21000 + 30 + 3};

SECTION_CRITICAL_DATA EventHandling::Event StressTestComponent30::event_Continue;

SECTION_CRITICAL_DATA DEFINE_TRIGGER(StressTestComponent30,selfCall,StressTestComponent30::mInstance,trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 2003);


StressTestComponent30::StressTestComponent30() : mIterations(0), mMin(0xFFFFFFFF), mMax(0) {
//	EventHandling::EventHandler::pInstance.subscribeEvent(&OSC_PREFIX(StressTestComponent31)::StressTestComponent31::event_Continue, &trigger_doStress);
}

void StressTestComponent30::func_doStress(dword_t arg) {
...
void StressTestComponent30::func_printOut(dword_t arg) {
...
void StressTestComponent30::func_subscribe(dword_t arg) {
//	EventHandling::EventHandler::pInstance.subscribeEvent(&OSC_PREFIX(StressTestComponent31)::StressTestComponent31::event_Continue, &trigger_doStress);
	EventHandling::EventHandler::pInstance.eventTriggered(&event_Continue,0);
}

DEFINE_TRIGGER_FUNC(StressTestComponent30,selfCall) {
	mIterations++;
