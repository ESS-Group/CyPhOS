...
#ifndef STRESSTEST_StressTestComponent118_H_
#define STRESSTEST_StressTestComponent118_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent118,StressTestComponent118, public ConsoleApplication)
public:
	StressTestComponent118();
	...
	static StressTestComponent118 mInstance;
...
#endif /* STRESSTEST_StressTestComponent118_H_ */
