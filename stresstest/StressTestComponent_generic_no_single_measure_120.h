...
#ifndef STRESSTEST_StressTestComponent120_H_
#define STRESSTEST_StressTestComponent120_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent120,StressTestComponent120, public ConsoleApplication)
public:
	StressTestComponent120();
	...
	static StressTestComponent120 mInstance;
...
#endif /* STRESSTEST_StressTestComponent120_H_ */
