...
#ifndef STRESSTEST_StressTestComponent74_H_
#define STRESSTEST_StressTestComponent74_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent74,StressTestComponent74, public ConsoleApplication)
public:
	StressTestComponent74();
	...
	static StressTestComponent74 mInstance;
...
#endif /* STRESSTEST_StressTestComponent74_H_ */
