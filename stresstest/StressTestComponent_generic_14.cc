...
#include "StressTestComponent_generic_15.h"

#define TAG "StressTestComponent14"
...
BEGIN_OSC_IMPLEMENTATION(StressTestComponent14,StressTestComponent14)

StressTestComponent14 StressTestComponent14::mInstance;

SECTION_CRITICAL_DATA OSC* StressTestComponent14::trigger_deps_doStress[] = {nullptr};

SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent14::trigger_doStress = {(OSC*)&StressTestComponent14::mInstance,(void (OSC::*)(dword_t))&StressTestComponent14::func_doStress,
				(OSC**)&StressTestComponent14::trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 14 + 1,0x0};

SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent14::trigger_subscribe = {(OSC*)&StressTestComponent14::mInstance,(void (OSC::*)(dword_t))&StressTestComponent14::func_subscribe,
				(OSC**)&StressTestComponent14::trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 14 + 2};

SECTION_CRITICAL_DATA OSC* StressTestComponent14::trigger_deps_printOut[] = {CONSOLE_BUFFER_DEP,nullptr};
SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent14::trigger_printOut = {(OSC*)&StressTestComponent14::mInstance,(void (OSC::*)(dword_t))&StressTestComponent14::func_printOut,
				(OSC**)&StressTestComponent14::trigger_deps_printOut, EventHandling::Trigger::cMIN_Priority + 21000 + 14 + 3};

SECTION_CRITICAL_DATA EventHandling::Event StressTestComponent14::event_Continue;

SECTION_CRITICAL_DATA DEFINE_TRIGGER(StressTestComponent14,selfCall,StressTestComponent14::mInstance,trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 2003);


StressTestComponent14::StressTestComponent14() : mIterations(0), mMin(0xFFFFFFFF), mMax(0) {
//	EventHandling::EventHandler::pInstance.subscribeEvent(&OSC_PREFIX(StressTestComponent15)::StressTestComponent15::event_Continue, &trigger_doStress);
}

void StressTestComponent14::func_doStress(dword_t arg) {
...
void StressTestComponent14::func_printOut(dword_t arg) {
...
void StressTestComponent14::func_subscribe(dword_t arg) {
//	EventHandling::EventHandler::pInstance.subscribeEvent(&OSC_PREFIX(StressTestComponent15)::StressTestComponent15::event_Continue, &trigger_doStress);
	EventHandling::EventHandler::pInstance.eventTriggered(&event_Continue,0);
}

DEFINE_TRIGGER_FUNC(StressTestComponent14,selfCall) {
	mIterations++;
