...
#ifndef STRESSTEST_StressTestComponent110_H_
#define STRESSTEST_StressTestComponent110_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent110,StressTestComponent110, public ConsoleApplication)
public:
	StressTestComponent110();
	...
	static StressTestComponent110 mInstance;
...
#endif /* STRESSTEST_StressTestComponent110_H_ */
