...
#ifndef STRESSTEST_StressTestComponent84_H_
#define STRESSTEST_StressTestComponent84_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent84,StressTestComponent84, public ConsoleApplication)
public:
	StressTestComponent84();
	...
	static StressTestComponent84 mInstance;
...
#endif /* STRESSTEST_StressTestComponent84_H_ */
