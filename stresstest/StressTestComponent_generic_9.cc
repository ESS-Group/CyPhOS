...
#include "StressTestComponent_generic_10.h"

#define TAG "StressTestComponent9"
...
BEGIN_OSC_IMPLEMENTATION(StressTestComponent9,StressTestComponent9)

StressTestComponent9 StressTestComponent9::mInstance;

SECTION_CRITICAL_DATA OSC* StressTestComponent9::trigger_deps_doStress[] = {nullptr};

SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent9::trigger_doStress = {(OSC*)&StressTestComponent9::mInstance,(void (OSC::*)(dword_t))&StressTestComponent9::func_doStress,
				(OSC**)&StressTestComponent9::trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 9 + 1,0x0};

SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent9::trigger_subscribe = {(OSC*)&StressTestComponent9::mInstance,(void (OSC::*)(dword_t))&StressTestComponent9::func_subscribe,
				(OSC**)&StressTestComponent9::trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 9 + 2};

SECTION_CRITICAL_DATA OSC* StressTestComponent9::trigger_deps_printOut[] = {CONSOLE_BUFFER_DEP,nullptr};
SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent9::trigger_printOut = {(OSC*)&StressTestComponent9::mInstance,(void (OSC::*)(dword_t))&StressTestComponent9::func_printOut,
				(OSC**)&StressTestComponent9::trigger_deps_printOut, EventHandling::Trigger::cMIN_Priority + 21000 + 9 + 3};

SECTION_CRITICAL_DATA EventHandling::Event StressTestComponent9::event_Continue;

SECTION_CRITICAL_DATA DEFINE_TRIGGER(StressTestComponent9,selfCall,StressTestComponent9::mInstance,trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 2003);


StressTestComponent9::StressTestComponent9() : mIterations(0), mMin(0xFFFFFFFF), mMax(0) {
//	EventHandling::EventHandler::pInstance.subscribeEvent(&OSC_PREFIX(StressTestComponent10)::StressTestComponent10::event_Continue, &trigger_doStress);
}

void StressTestComponent9::func_doStress(dword_t arg) {
...
void StressTestComponent9::func_printOut(dword_t arg) {
...
void StressTestComponent9::func_subscribe(dword_t arg) {
//	EventHandling::EventHandler::pInstance.subscribeEvent(&OSC_PREFIX(StressTestComponent10)::StressTestComponent10::event_Continue, &trigger_doStress);
	EventHandling::EventHandler::pInstance.eventTriggered(&event_Continue,0);
}

DEFINE_TRIGGER_FUNC(StressTestComponent9,selfCall) {
	mIterations++;
