...
#include "StressTestComponent_generic_5.h"

#define TAG "StressTestComponent4"
...
BEGIN_OSC_IMPLEMENTATION(StressTestComponent4,StressTestComponent4)

StressTestComponent4 StressTestComponent4::mInstance;

SECTION_CRITICAL_DATA OSC* StressTestComponent4::trigger_deps_doStress[] = {nullptr};

SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent4::trigger_doStress = {(OSC*)&StressTestComponent4::mInstance,(void (OSC::*)(dword_t))&StressTestComponent4::func_doStress,
				(OSC**)&StressTestComponent4::trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 4 + 1,0x0};

SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent4::trigger_subscribe = {(OSC*)&StressTestComponent4::mInstance,(void (OSC::*)(dword_t))&StressTestComponent4::func_subscribe,
				(OSC**)&StressTestComponent4::trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 4 + 2};

SECTION_CRITICAL_DATA OSC* StressTestComponent4::trigger_deps_printOut[] = {CONSOLE_BUFFER_DEP,nullptr};
SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent4::trigger_printOut = {(OSC*)&StressTestComponent4::mInstance,(void (OSC::*)(dword_t))&StressTestComponent4::func_printOut,
				(OSC**)&StressTestComponent4::trigger_deps_printOut, EventHandling::Trigger::cMIN_Priority + 21000 + 4 + 3};

SECTION_CRITICAL_DATA EventHandling::Event StressTestComponent4::event_Continue;

SECTION_CRITICAL_DATA DEFINE_TRIGGER(StressTestComponent4,selfCall,StressTestComponent4::mInstance,trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 2003);


StressTestComponent4::StressTestComponent4() : mIterations(0), mMin(0xFFFFFFFF), mMax(0) {
//	EventHandling::EventHandler::pInstance.subscribeEvent(&OSC_PREFIX(StressTestComponent5)::StressTestComponent5::event_Continue, &trigger_doStress);
}

void StressTestComponent4::func_doStress(dword_t arg) {
...
void StressTestComponent4::func_printOut(dword_t arg) {
...
void StressTestComponent4::func_subscribe(dword_t arg) {
//	EventHandling::EventHandler::pInstance.subscribeEvent(&OSC_PREFIX(StressTestComponent5)::StressTestComponent5::event_Continue, &trigger_doStress);
	EventHandling::EventHandler::pInstance.eventTriggered(&event_Continue,0);
}

DEFINE_TRIGGER_FUNC(StressTestComponent4,selfCall) {
	mIterations++;
