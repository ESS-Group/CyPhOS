...
#ifndef STRESSTEST_StressTestComponent113_H_
#define STRESSTEST_StressTestComponent113_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent113,StressTestComponent113, public ConsoleApplication)
public:
	StressTestComponent113();
	...
	static StressTestComponent113 mInstance;
...
#endif /* STRESSTEST_StressTestComponent113_H_ */
