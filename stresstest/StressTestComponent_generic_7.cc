...
#include "StressTestComponent_generic_8.h"

#define TAG "StressTestComponent7"
...
BEGIN_OSC_IMPLEMENTATION(StressTestComponent7,StressTestComponent7)

StressTestComponent7 StressTestComponent7::mInstance;

SECTION_CRITICAL_DATA OSC* StressTestComponent7::trigger_deps_doStress[] = {nullptr};

SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent7::trigger_doStress = {(OSC*)&StressTestComponent7::mInstance,(void (OSC::*)(dword_t))&StressTestComponent7::func_doStress,
				(OSC**)&StressTestComponent7::trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 7 + 1,0x0};

SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent7::trigger_subscribe = {(OSC*)&StressTestComponent7::mInstance,(void (OSC::*)(dword_t))&StressTestComponent7::func_subscribe,
				(OSC**)&StressTestComponent7::trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 7 + 2};

SECTION_CRITICAL_DATA OSC* StressTestComponent7::trigger_deps_printOut[] = {CONSOLE_BUFFER_DEP,nullptr};
SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent7::trigger_printOut = {(OSC*)&StressTestComponent7::mInstance,(void (OSC::*)(dword_t))&StressTestComponent7::func_printOut,
				(OSC**)&StressTestComponent7::trigger_deps_printOut, EventHandling::Trigger::cMIN_Priority + 21000 + 7 + 3};

SECTION_CRITICAL_DATA EventHandling::Event StressTestComponent7::event_Continue;

SECTION_CRITICAL_DATA DEFINE_TRIGGER(StressTestComponent7,selfCall,StressTestComponent7::mInstance,trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 2003);


StressTestComponent7::StressTestComponent7() : mIterations(0), mMin(0xFFFFFFFF), mMax(0) {
//	EventHandling::EventHandler::pInstance.subscribeEvent(&OSC_PREFIX(StressTestComponent8)::StressTestComponent8::event_Continue, &trigger_doStress);
}

void StressTestComponent7::func_doStress(dword_t arg) {
...
void StressTestComponent7::func_printOut(dword_t arg) {
...
void StressTestComponent7::func_subscribe(dword_t arg) {
//	EventHandling::EventHandler::pInstance.subscribeEvent(&OSC_PREFIX(StressTestComponent8)::StressTestComponent8::event_Continue, &trigger_doStress);
	EventHandling::EventHandler::pInstance.eventTriggered(&event_Continue,0);
}

DEFINE_TRIGGER_FUNC(StressTestComponent7,selfCall) {
	mIterations++;
