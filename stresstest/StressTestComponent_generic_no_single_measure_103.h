...
#ifndef STRESSTEST_StressTestComponent103_H_
#define STRESSTEST_StressTestComponent103_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent103,StressTestComponent103, public ConsoleApplication)
public:
	StressTestComponent103();
	...
	static StressTestComponent103 mInstance;
...
#endif /* STRESSTEST_StressTestComponent103_H_ */
