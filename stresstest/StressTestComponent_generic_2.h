/*
 * StressTestComponent2.h
 *
 *  Created on: 09.03.2017
 *      Author: hendrik
 */

#ifndef STRESSTEST_StressTestComponent2_H_
#define STRESSTEST_StressTestComponent2_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent2,StressTestComponent2, public ConsoleApplication)
public:
	StressTestComponent2();
	...
	static StressTestComponent2 mInstance;
...
#endif /* STRESSTEST_StressTestComponent2_H_ */
