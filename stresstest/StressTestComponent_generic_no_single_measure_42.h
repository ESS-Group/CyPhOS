...
#ifndef STRESSTEST_StressTestComponent42_H_
#define STRESSTEST_StressTestComponent42_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent42,StressTestComponent42, public ConsoleApplication)
public:
	StressTestComponent42();
	...
	static StressTestComponent42 mInstance;
...
#endif /* STRESSTEST_StressTestComponent42_H_ */
