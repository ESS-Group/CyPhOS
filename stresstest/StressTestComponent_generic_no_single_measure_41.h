...
#ifndef STRESSTEST_StressTestComponent41_H_
#define STRESSTEST_StressTestComponent41_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent41,StressTestComponent41, public ConsoleApplication)
public:
	StressTestComponent41();
	...
	static StressTestComponent41 mInstance;
...
#endif /* STRESSTEST_StressTestComponent41_H_ */
