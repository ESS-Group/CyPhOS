...
#ifndef STRESSTEST_StressTestComponent78_H_
#define STRESSTEST_StressTestComponent78_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent78,StressTestComponent78, public ConsoleApplication)
public:
	StressTestComponent78();
	...
	static StressTestComponent78 mInstance;
...
#endif /* STRESSTEST_StressTestComponent78_H_ */
