...
#ifndef STRESSTEST_StressTestComponent81_H_
#define STRESSTEST_StressTestComponent81_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent81,StressTestComponent81, public ConsoleApplication)
public:
	StressTestComponent81();
	...
	static StressTestComponent81 mInstance;
...
#endif /* STRESSTEST_StressTestComponent81_H_ */
