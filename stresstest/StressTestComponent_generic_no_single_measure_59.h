...
#ifndef STRESSTEST_StressTestComponent59_H_
#define STRESSTEST_StressTestComponent59_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent59,StressTestComponent59, public ConsoleApplication)
public:
	StressTestComponent59();
	...
	static StressTestComponent59 mInstance;
...
#endif /* STRESSTEST_StressTestComponent59_H_ */
