...
#ifndef STRESSTEST_StressTestComponent124_H_
#define STRESSTEST_StressTestComponent124_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent124,StressTestComponent124, public ConsoleApplication)
public:
	StressTestComponent124();
	...
	static StressTestComponent124 mInstance;
...
#endif /* STRESSTEST_StressTestComponent124_H_ */
