...
#include "StressTestComponent_generic_30.h"

#define TAG "StressTestComponent29"
...
BEGIN_OSC_IMPLEMENTATION(StressTestComponent29,StressTestComponent29)

StressTestComponent29 StressTestComponent29::mInstance;

SECTION_CRITICAL_DATA OSC* StressTestComponent29::trigger_deps_doStress[] = {nullptr};

SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent29::trigger_doStress = {(OSC*)&StressTestComponent29::mInstance,(void (OSC::*)(dword_t))&StressTestComponent29::func_doStress,
				(OSC**)&StressTestComponent29::trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 29 + 1,0x0};

SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent29::trigger_subscribe = {(OSC*)&StressTestComponent29::mInstance,(void (OSC::*)(dword_t))&StressTestComponent29::func_subscribe,
				(OSC**)&StressTestComponent29::trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 29 + 2};

SECTION_CRITICAL_DATA OSC* StressTestComponent29::trigger_deps_printOut[] = {CONSOLE_BUFFER_DEP,nullptr};
SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent29::trigger_printOut = {(OSC*)&StressTestComponent29::mInstance,(void (OSC::*)(dword_t))&StressTestComponent29::func_printOut,
				(OSC**)&StressTestComponent29::trigger_deps_printOut, EventHandling::Trigger::cMIN_Priority + 21000 + 29 + 3};

SECTION_CRITICAL_DATA EventHandling::Event StressTestComponent29::event_Continue;

SECTION_CRITICAL_DATA DEFINE_TRIGGER(StressTestComponent29,selfCall,StressTestComponent29::mInstance,trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 2003);


StressTestComponent29::StressTestComponent29() : mIterations(0), mMin(0xFFFFFFFF), mMax(0) {
//	EventHandling::EventHandler::pInstance.subscribeEvent(&OSC_PREFIX(StressTestComponent30)::StressTestComponent30::event_Continue, &trigger_doStress);
}

void StressTestComponent29::func_doStress(dword_t arg) {
...
void StressTestComponent29::func_printOut(dword_t arg) {
...
void StressTestComponent29::func_subscribe(dword_t arg) {
//	EventHandling::EventHandler::pInstance.subscribeEvent(&OSC_PREFIX(StressTestComponent30)::StressTestComponent30::event_Continue, &trigger_doStress);
	EventHandling::EventHandler::pInstance.eventTriggered(&event_Continue,0);
}

DEFINE_TRIGGER_FUNC(StressTestComponent29,selfCall) {
	mIterations++;
