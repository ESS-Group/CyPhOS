...
#ifndef STRESSTEST_StressTestComponent116_H_
#define STRESSTEST_StressTestComponent116_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent116,StressTestComponent116, public ConsoleApplication)
public:
	StressTestComponent116();
	...
	static StressTestComponent116 mInstance;
...
#endif /* STRESSTEST_StressTestComponent116_H_ */
