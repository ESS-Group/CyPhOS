...
#ifndef STRESSTEST_StressTestComponent82_H_
#define STRESSTEST_StressTestComponent82_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent82,StressTestComponent82, public ConsoleApplication)
public:
	StressTestComponent82();
	...
	static StressTestComponent82 mInstance;
...
#endif /* STRESSTEST_StressTestComponent82_H_ */
