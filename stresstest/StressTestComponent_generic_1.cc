...
#include "StressTestComponent_generic_2.h"

#define TAG "StressTestComponent1"
...
BEGIN_OSC_IMPLEMENTATION(StressTestComponent1,StressTestComponent1)

StressTestComponent1 StressTestComponent1::mInstance;

SECTION_CRITICAL_DATA OSC* StressTestComponent1::trigger_deps_doStress[] = {nullptr};

SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent1::trigger_doStress = {(OSC*)&StressTestComponent1::mInstance,(void (OSC::*)(dword_t))&StressTestComponent1::func_doStress,
				(OSC**)&StressTestComponent1::trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 1 + 1,0x0};

SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent1::trigger_subscribe = {(OSC*)&StressTestComponent1::mInstance,(void (OSC::*)(dword_t))&StressTestComponent1::func_subscribe,
				(OSC**)&StressTestComponent1::trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 1 + 2};

SECTION_CRITICAL_DATA OSC* StressTestComponent1::trigger_deps_printOut[] = {CONSOLE_BUFFER_DEP,nullptr};
SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent1::trigger_printOut = {(OSC*)&StressTestComponent1::mInstance,(void (OSC::*)(dword_t))&StressTestComponent1::func_printOut,
				(OSC**)&StressTestComponent1::trigger_deps_printOut, EventHandling::Trigger::cMIN_Priority + 21000 + 1 + 3};

SECTION_CRITICAL_DATA EventHandling::Event StressTestComponent1::event_Continue;

SECTION_CRITICAL_DATA DEFINE_TRIGGER(StressTestComponent1,selfCall,StressTestComponent1::mInstance,trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 2003);


StressTestComponent1::StressTestComponent1() : mIterations(0), mMin(0xFFFFFFFF), mMax(0) {
//	EventHandling::EventHandler::pInstance.subscribeEvent(&OSC_PREFIX(StressTestComponent2)::StressTestComponent2::event_Continue, &trigger_doStress);
}

void StressTestComponent1::func_doStress(dword_t arg) {
...
void StressTestComponent1::func_printOut(dword_t arg) {
...
void StressTestComponent1::func_subscribe(dword_t arg) {
//	EventHandling::EventHandler::pInstance.subscribeEvent(&OSC_PREFIX(StressTestComponent2)::StressTestComponent2::event_Continue, &trigger_doStress);
	EventHandling::EventHandler::pInstance.eventTriggered(&event_Continue,0);
}

DEFINE_TRIGGER_FUNC(StressTestComponent1,selfCall) {
	mIterations++;
