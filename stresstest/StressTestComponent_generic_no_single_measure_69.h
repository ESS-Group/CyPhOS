...
#ifndef STRESSTEST_StressTestComponent69_H_
#define STRESSTEST_StressTestComponent69_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent69,StressTestComponent69, public ConsoleApplication)
public:
	StressTestComponent69();
	...
	static StressTestComponent69 mInstance;
...
#endif /* STRESSTEST_StressTestComponent69_H_ */
