...
#ifndef STRESSTEST_StressTestComponent106_H_
#define STRESSTEST_StressTestComponent106_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent106,StressTestComponent106, public ConsoleApplication)
public:
	StressTestComponent106();
	...
	static StressTestComponent106 mInstance;
...
#endif /* STRESSTEST_StressTestComponent106_H_ */
