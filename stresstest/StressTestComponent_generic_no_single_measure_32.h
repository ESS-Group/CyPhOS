...
#ifndef STRESSTEST_StressTestComponent32_H_
#define STRESSTEST_StressTestComponent32_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent32,StressTestComponent32, public ConsoleApplication)
public:
	StressTestComponent32();
	...
	static StressTestComponent32 mInstance;
...
#endif /* STRESSTEST_StressTestComponent32_H_ */
