...
#ifndef STRESSTEST_StressTestComponent94_H_
#define STRESSTEST_StressTestComponent94_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent94,StressTestComponent94, public ConsoleApplication)
public:
	StressTestComponent94();
	...
	static StressTestComponent94 mInstance;
...
#endif /* STRESSTEST_StressTestComponent94_H_ */
