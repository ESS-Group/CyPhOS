...
#ifndef STRESSTEST_StressTestComponent96_H_
#define STRESSTEST_StressTestComponent96_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent96,StressTestComponent96, public ConsoleApplication)
public:
	StressTestComponent96();
	...
	static StressTestComponent96 mInstance;
...
#endif /* STRESSTEST_StressTestComponent96_H_ */
