...
#ifndef STRESSTEST_StressTestComponent46_H_
#define STRESSTEST_StressTestComponent46_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent46,StressTestComponent46, public ConsoleApplication)
public:
	StressTestComponent46();
	...
	static StressTestComponent46 mInstance;
...
#endif /* STRESSTEST_StressTestComponent46_H_ */
