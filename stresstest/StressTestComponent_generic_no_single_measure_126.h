...
#ifndef STRESSTEST_StressTestComponent126_H_
#define STRESSTEST_StressTestComponent126_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent126,StressTestComponent126, public ConsoleApplication)
public:
	StressTestComponent126();
	...
	static StressTestComponent126 mInstance;
...
#endif /* STRESSTEST_StressTestComponent126_H_ */
