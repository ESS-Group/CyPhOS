...
#ifndef STRESSTEST_StressTestComponent68_H_
#define STRESSTEST_StressTestComponent68_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent68,StressTestComponent68, public ConsoleApplication)
public:
	StressTestComponent68();
	...
	static StressTestComponent68 mInstance;
...
#endif /* STRESSTEST_StressTestComponent68_H_ */
