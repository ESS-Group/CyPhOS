...
#ifndef STRESSTEST_StressTestComponent123_H_
#define STRESSTEST_StressTestComponent123_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent123,StressTestComponent123, public ConsoleApplication)
public:
	StressTestComponent123();
	...
	static StressTestComponent123 mInstance;
...
#endif /* STRESSTEST_StressTestComponent123_H_ */
