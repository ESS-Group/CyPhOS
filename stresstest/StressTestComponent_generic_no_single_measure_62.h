...
#ifndef STRESSTEST_StressTestComponent62_H_
#define STRESSTEST_StressTestComponent62_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent62,StressTestComponent62, public ConsoleApplication)
public:
	StressTestComponent62();
	...
	static StressTestComponent62 mInstance;
...
#endif /* STRESSTEST_StressTestComponent62_H_ */
