...
#ifndef STRESSTEST_StressTestComponent63_H_
#define STRESSTEST_StressTestComponent63_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent63,StressTestComponent63, public ConsoleApplication)
public:
	StressTestComponent63();
	...
	static StressTestComponent63 mInstance;
...
#endif /* STRESSTEST_StressTestComponent63_H_ */
