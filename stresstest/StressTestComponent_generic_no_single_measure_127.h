...
#ifndef STRESSTEST_StressTestComponent127_H_
#define STRESSTEST_StressTestComponent127_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent127,StressTestComponent127, public ConsoleApplication)
public:
	StressTestComponent127();
	...
	static StressTestComponent127 mInstance;
...
#endif /* STRESSTEST_StressTestComponent127_H_ */
