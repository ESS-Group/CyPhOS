...
#ifndef STRESSTEST_StressTestComponent99_H_
#define STRESSTEST_StressTestComponent99_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent99,StressTestComponent99, public ConsoleApplication)
public:
	StressTestComponent99();
	...
	static StressTestComponent99 mInstance;
...
#endif /* STRESSTEST_StressTestComponent99_H_ */
