...
#include "StressTestComponent_generic_26.h"

#define TAG "StressTestComponent25"
...
BEGIN_OSC_IMPLEMENTATION(StressTestComponent25,StressTestComponent25)

StressTestComponent25 StressTestComponent25::mInstance;

SECTION_CRITICAL_DATA OSC* StressTestComponent25::trigger_deps_doStress[] = {nullptr};

SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent25::trigger_doStress = {(OSC*)&StressTestComponent25::mInstance,(void (OSC::*)(dword_t))&StressTestComponent25::func_doStress,
				(OSC**)&StressTestComponent25::trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 25 + 1,0x0};

SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent25::trigger_subscribe = {(OSC*)&StressTestComponent25::mInstance,(void (OSC::*)(dword_t))&StressTestComponent25::func_subscribe,
				(OSC**)&StressTestComponent25::trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 25 + 2};

SECTION_CRITICAL_DATA OSC* StressTestComponent25::trigger_deps_printOut[] = {CONSOLE_BUFFER_DEP,nullptr};
SECTION_CRITICAL_DATA EventHandling::Trigger StressTestComponent25::trigger_printOut = {(OSC*)&StressTestComponent25::mInstance,(void (OSC::*)(dword_t))&StressTestComponent25::func_printOut,
				(OSC**)&StressTestComponent25::trigger_deps_printOut, EventHandling::Trigger::cMIN_Priority + 21000 + 25 + 3};

SECTION_CRITICAL_DATA EventHandling::Event StressTestComponent25::event_Continue;

SECTION_CRITICAL_DATA DEFINE_TRIGGER(StressTestComponent25,selfCall,StressTestComponent25::mInstance,trigger_deps_doStress, EventHandling::Trigger::cMIN_Priority + 2003);


StressTestComponent25::StressTestComponent25() : mIterations(0), mMin(0xFFFFFFFF), mMax(0) {
//	EventHandling::EventHandler::pInstance.subscribeEvent(&OSC_PREFIX(StressTestComponent26)::StressTestComponent26::event_Continue, &trigger_doStress);
}

void StressTestComponent25::func_doStress(dword_t arg) {
...
void StressTestComponent25::func_printOut(dword_t arg) {
...
void StressTestComponent25::func_subscribe(dword_t arg) {
//	EventHandling::EventHandler::pInstance.subscribeEvent(&OSC_PREFIX(StressTestComponent26)::StressTestComponent26::event_Continue, &trigger_doStress);
	EventHandling::EventHandler::pInstance.eventTriggered(&event_Continue,0);
}

DEFINE_TRIGGER_FUNC(StressTestComponent25,selfCall) {
	mIterations++;
