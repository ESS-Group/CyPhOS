...
#ifndef STRESSTEST_StressTestComponent38_H_
#define STRESSTEST_StressTestComponent38_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent38,StressTestComponent38, public ConsoleApplication)
public:
	StressTestComponent38();
	...
	static StressTestComponent38 mInstance;
...
#endif /* STRESSTEST_StressTestComponent38_H_ */
