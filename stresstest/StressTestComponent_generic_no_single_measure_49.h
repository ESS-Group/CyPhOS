...
#ifndef STRESSTEST_StressTestComponent49_H_
#define STRESSTEST_StressTestComponent49_H_

#include <eventhandling/Event.h>

#include <testcomponents/ConsoleApplication.h>

BEGIN_DECLARE_OSC_INHERIT(StressTestComponent49,StressTestComponent49, public ConsoleApplication)
public:
	StressTestComponent49();
	...
	static StressTestComponent49 mInstance;
...
#endif /* STRESSTEST_StressTestComponent49_H_ */
